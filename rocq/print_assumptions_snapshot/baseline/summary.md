...
| `compose_gcd_id_l` | 450 | 0 | 0 | OK |
| `compose_gcd_id_r` | 457 | 0 | 0 | OK |
| `dirichlet_B_id_l` | 464 | 0 | 0 | OK |
| `compose_id_left` | 471 | 0 | 0 | OK |
| `compose_inv_gcd` | 497 | 0 | 0 | OK |
| `compose_inv_leading_one` | 505 | 0 | 0 | OK |
| `dirichlet_B_inv_plus_2` | 515 | 0 | 0 | OK |
| `four_divides_B2_minus_disc_inv` | 528 | 0 | 0 | OK |
| `reconstruct_disc_div4` | 538 | 0 | 0 | OK |
| `compose_inv_c` | 545 | 0 | 0 | OK |
| `compose_inv_primitive` | 558 | 0 | 0 | OK |
| `compose_inv_of_disc` | 569 | 0 | 0 | OK |
| `form_a_one_equiv_id` | 589 | 0 | 0 | OK |
| `compose_inv_equiv_id` | 666 | 0 | 0 | OK |
| `ambiguous_div_is_ambiguous` | 695 | 0 | 0 | OK |
| `solve_cong_target_0` | 699 | 0 | 0 | OK |
| `compose_self_gcd_div` | 710 | 0 | 0 | OK |
| `dirichlet_B_self_div` | 727 | 0 | 0 | OK |
| `compose_self_leading_one` | 736 | 0 | 0 | OK |
| `compose_self_b` | 748 | 0 | 0 | OK |
| `compose_self_c` | 754 | 0 | 0 | OK |
| `four_divides_b2_minus_disc` | 770 | 0 | 0 | OK |
| `compose_self_of_disc` | 777 | 0 | 0 | OK |
| `compose_self_ambiguous_equiv_id` | 799 | 0 | 0 | OK |
| `compose_assoc_id_inv` | 832 | 0 | 0 | OK |
| `compose_assoc_id_ff` | 851 | 0 | 0 | OK |
| `amb_from_div_ambiguous` | 873 | 0 | 0 | OK |
| `amb_from_div_disc_mod0` | 881 | 0 | 0 | OK |
| `amb_from_div_disc_mod1` | 899 | 0 | 0 | OK |
| `iq_neg23` | 939 | 0 | 0 | OK |
| `iq_neg47` | 942 | 0 | 0 | OK |
| `iq_neg87` | 945 | 0 | 0 | OK |
| `iq_neg403` | 948 | 0 | 0 | OK |
| `iq_neg455` | 951 | 0 | 0 | OK |
| `form_neg87_amb_of_disc` | 954 | 0 | 0 | OK |
| `form_neg403_amb_of_disc` | 957 | 0 | 0 | OK |
| `form_neg403_amb_red_of_disc` | 960 | 0 | 0 | OK |
| `form_neg455_5_of_disc` | 963 | 0 | 0 | OK |
| `form_neg455_7_of_disc` | 966 | 0 | 0 | OK |
| `form_neg455_13_red_of_disc` | 969 | 0 | 0 | OK |
| `form_neg87_amb_reduced` | 972 | 0 | 0 | OK |
| `form_neg403_amb_red_reduced` | 975 | 0 | 0 | OK |
| `form_neg455_5_reduced` | 978 | 0 | 0 | OK |
| `form_neg455_7_reduced` | 981 | 0 | 0 | OK |
| `form_neg455_13_red_reduced` | 984 | 0 | 0 | OK |
| `form_neg87_amb_is_ambiguous` | 987 | 0 | 0 | OK |
| `form_neg403_amb_is_ambiguous` | 990 | 0 | 0 | OK |
| `form_neg403_amb_red_is_ambiguous` | 993 | 0 | 0 | OK |
| `form_neg455_5_is_ambiguous` | 996 | 0 | 0 | OK |
| `form_neg455_7_is_ambiguous` | 999 | 0 | 0 | OK |
| `form_neg455_13_red_is_ambiguous` | 1002 | 0 | 0 | OK |
| `form_neg87_not_principal` | 1005 | 0 | 0 | OK |
| `form_neg403_not_principal` | 1014 | 0 | 0 | OK |
| `form_neg455_5_not_principal` | 1023 | 0 | 0 | OK |
| `form_neg455_7_not_principal` | 1032 | 0 | 0 | OK |
| `form_neg455_13_not_principal` | 1041 | 0 | 0 | OK |
| `catalog_compose_inv_is_principal` | 1059 | 0 | 0 | OK |
| `compose_id_right_neg87` | 1078 | 0 | 0 | OK |
| `compose_id_right_neg455_5` | 1082 | 0 | 0 | OK |
| `compose_neg455_5_7_of_disc` | 1086 | 0 | 0 | OK |
| `compose_neg455_5_7_leading` | 1093 | 0 | 0 | OK |
| `compose_neg455_5_7_not_units` | 1097 | 0 | 0 | OK |
| `catalog_wins_LowOrder_B2` | 1104 | 0 | 0 | OK |
| `bqf_exp_0` | 1137 | 0 | 0 | OK |
| `bqf_exp_1` | 1140 | 0 | 0 | OK |
| `bqf_exp_2` | 1150 | 0 | 0 | OK |
| `bqf_exp_2_ambiguous_div` | 1160 | 0 | 0 | OK |
...
| `form_neg31_sq_of_disc` | 219 | 0 | 0 | OK |
| `compose_assoc_id_ff_neg31` | 225 | 0 | 0 | OK |
| `compose_assoc_neg31_ord3` | 235 | 0 | 0 | OK |
| `form_neg31_exp2` | 247 | 0 | 0 | OK |
| `form_neg31_exp3` | 254 | 0 | 0 | OK |
| `form_neg31_sq_equiv_inv` | 263 | 0 | 0 | OK |
| `form_neg31_inv_reduced` | 270 | 0 | 0 | OK |
| `form_neg31_inv_of_disc` | 273 | 0 | 0 | OK |
| `form_neg31_inv_not_principal` | 280 | 0 | 0 | OK |
| `form_neg31_actS_inv_is_sq` | 289 | 0 | 0 | OK |
| `form_neg31_sq_not_principal` | 293 | 0 | 0 | OK |
| `sl2_reduce_cube_ok` | 307 | 0 | 0 | OK |
| `form_neg31_cube_equiv_id` | 310 | 0 | 0 | OK |
| `form_neg31_exp3_equiv_id` | 317 | 0 | 0 | OK |
| `form_neg31_exp1` | 321 | 0 | 0 | OK |
| `mersenne31_wins_restricted_LowOrder` | 340 | 0 | 0 | OK |
| `mersenne31_is_odd_order` | 357 | 0 | 0 | OK |
| `shanks_disc_2` | 373 | 0 | 0 | OK |
| `shanks_form_2` | 376 | 0 | 0 | OK |
| `shanks_form_disc` | 379 | 0 | 0 | OK |
| `shanks_disc_3` | 389 | 0 | 0 | OK |
| `iq_neg107` | 392 | 0 | 0 | OK |
| `shanks_u3_of_disc` | 395 | 0 | 0 | OK |
| `shanks_u3_not_ambiguous` | 402 | 0 | 0 | OK |
| `shanks_u3_exp3_compute` | 413 | 0 | 0 | OK |
| `shanks_u3_cube_equiv_id` | 421 | 0 | 0 | OK |
| `shanks_u3_exp3_equiv_id` | 428 | 0 | 0 | OK |
| `shanks_family_has_3` | 432 | 0 | 0 | OK |
| `mersenne31_shanks_in_family_H` | 450 | 0 | 0 | OK |
| `mersenne31_shanks_not_ordinary_H` | 457 | 0 | 0 | OK |
| `bqf_exp_id` | 470 | 0 | 0 | OK |
| `neg31_id_annihilated_by_h` | 481 | 0 | 0 | OK |
| `form_neg31_inv_exp2` | 488 | 0 | 0 | OK |
| `form_neg31_inv_sq_equiv_f` | 495 | 0 | 0 | OK |
| `shanks_inv_square_is_shanks` | 502 | 0 | 0 | OK |
| `shanks_annihilated_by_h` | 510 | 0 | 0 | OK |
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `gra_inv_eq_gcd_if_nonunit` | 57 | 0 | 0 | OK |
| `gra_inv_proper_gcd_factors` | 65 | 0 | 0 | OK |
| `gra_first_inv_gcd_some` | 133 | 0 | 0 | OK |
| `gra_first_inv_gcd_factors` | 155 | 0 | 0 | OK |
| `gra_eq_tape_88` | 184 | 0 | 0 | OK |
| `gra_eq_tape_zero` | 188 | 0 | 0 | OK |
| `gra_eq_leak_pin` | 192 | 0 | 0 | OK |
| `gra_eq_leak_factors` | 196 | 0 | 0 | OK |
| `gra_eq_leak_onesided` | 204 | 0 | 0 | OK |
| `gra_eq_N_is_not_a_split` | 208 | 0 | 0 | OK |
| `gra_mul_y_pin` | 212 | 0 | 0 | OK |
| `gra_const42` | 216 | 0 | 0 | OK |
| `slp_init_eval` | 241 | 0 | 0 | OK |
| `slp_to_poly_mul_pin` | 252 | 0 | 0 | OK |
| `nth_app_last` | 270 | 0 | 0 | OK |
| `nth_app_lt` | 277 | 0 | 0 | OK |
| `step_length` | 285 | 0 | 0 | OK |
| `step_poly_length` | 289 | 0 | 0 | OK |
| `step_nodiv_prefix` | 293 | 0 | 0 | OK |
| `step_nodiv_new` | 307 | 0 | 0 | OK |
| `step_nodiv_overflow` | 327 | 0 | 0 | OK |
| `step_nodiv_agree` | 340 | 0 | 0 | OK |
| `gra_run_nodiv_agree` | 360 | 0 | 0 | OK |
| `slp_init_length` | 377 | 0 | 0 | OK |
| `gra_init_length` | 380 | 0 | 0 | OK |
| `gra_init_agrees` | 383 | 0 | 0 | OK |
| `gra_nodiv_denotes` | 396 | 0 | 0 | OK |
| `nodiv_gra_unit_invs` | 469 | 0 | 0 | OK |
| `step_rat_length` | 480 | 0 | 0 | OK |
| `rat_overflow_agrees` | 484 | 0 | 0 | OK |
| `gra_init_rat_agrees` | 492 | 0 | 0 | OK |
| `rat_add_cong` | 520 | 0 | 0 | OK |
| `rat_sub_cong` | 538 | 0 | 0 | OK |
| `rat_mul_cong` | 556 | 0 | 0 | OK |
| `rat_inv_cong` | 571 | 0 | 0 | OK |
| `rat_inv_den_coprime` | 588 | 0 | 0 | OK |
| `step_unit_inv_agrees` | 604 | 0 | 0 | OK |
| `gra_run_unit_inv_agree` | 693 | 0 | 0 | OK |
| `gra_unit_inv_denotes` | 728 | 0 | 0 | OK |
| `slp_init_deg_le` | 768 | 0 | 0 | OK |
| `step_deg_bound_length` | 780 | 0 | 0 | OK |
| `step_nodiv_degree_le` | 784 | 0 | 0 | OK |
| `gra_run_poly_length` | 815 | 0 | 0 | OK |
| `gra_nodiv_degree_le` | 823 | 0 | 0 | OK |
| `gra_deg_bound_identity` | 848 | 0 | 0 | OK |
| `gra_deg_bound_square` | 852 | 0 | 0 | OK |
| `gra_deg_bound_x3` | 856 | 0 | 0 | OK |
| `gra_deg_bound_x4` | 860 | 0 | 0 | OK |
| `gra_nodiv_mul_is_nodiv` | 864 | 0 | 0 | OK |
| `gra_nodiv_mul_denotes_square` | 868 | 0 | 0 | OK |
| `gra_nodiv_integer_eth_root_forbidden` | 875 | 0 | 0 | OK |
| `gra_nodiv_const42_inverts_36` | 893 | 0 | 0 | OK |
| `gra_nodiv_const42_fails_on_8` | 897 | 0 | 0 | OK |
| `gra_identity_not_cube_root_at_2` | 901 | 0 | 0 | OK |
| `gra_identity_at_one` | 905 | 0 | 0 | OK |
| `gra_identity_gcd_at_2` | 909 | 0 | 0 | OK |
| `gra_nodiv_identical_X3_linear` | 913 | 0 | 0 | OK |
| `gra_nodiv_N_does_not_divide_minus1` | 917 | 0 | 0 | OK |
| `gra_nodiv_identical_root_impossible_X3` | 921 | 0 | 0 | OK |
| `Pe_minus_X_eval2_is_six_on_X` | 929 | 0 | 0 | OK |
| `gra_inv_nonunit_pin` | 942 | 0 | 0 | OK |
| `gra_inv_nonunit_factors` | 946 | 0 | 0 | OK |
| `pin_gra_inv11_first_gcd` | 953 | 0 | 0 | OK |
| `pin_gra_inv36_first_gcd_none` | 957 | 0 | 0 | OK |
| `pin_gra_square_first_gcd_none` | 961 | 0 | 0 | OK |
| `pin_units_gra_inv_ok` | 975 | 0 | 0 | OK |
| `units_gra_inv_ok_spec` | 979 | 0 | 0 | OK |
| `pin_gra_inv_inverts_reduced_unit` | 1001 | 0 | 0 | OK |
| `pin_ginv_of_y_unit_invs` | 1013 | 0 | 0 | OK |
| `integer_cube_root_p3` | 1034 | 0 | 0 | OK |
| `gra_root_p3_from_tape` | 1038 | 0 | 0 | OK |
| `gra_root_p3_factors` | 1042 | 0 | 0 | OK |
| `gra_first_root_factor_some` | 1064 | 0 | 0 | OK |
| `gra_first_root_factor_factors` | 1087 | 0 | 0 | OK |
| `pin_gra_root_p3_first_factor` | 1098 | 0 | 0 | OK |
| `pin_gra_root_8_first_none` | 1102 | 0 | 0 | OK |
| `gra_inv_22_from_tape` | 1106 | 0 | 0 | OK |
| `gra_inv_unit_gcd` | 1110 | 0 | 0 | OK |
| `gra_inv_unit_from_tape` | 1114 | 0 | 0 | OK |
| `gra_fixed_e_leading_const` | 1118 | 0 | 0 | OK |
| `gra_fixed_e_leading` | 1122 | 0 | 0 | OK |
| `rsa_inverter_is_not_a_GRA_comment` | 1128 | 0 | 0 | OK |
| `powm_d_inverts_cube_pin` | 1134 | 0 | 0 | OK |
| `gra_const_81` | 1140 | 0 | 0 | OK |
| `gra_const_lambda_plus_one_solves_sRSA_without_factoring` | 1145 | 0 | 0 | OK |
| `gra_const_81_does_not_factor` | 1155 | 0 | 0 | OK |
| `lambda_plus_one_is_81` | 1159 | 0 | 0 | OK |
| `gra_add_mul_of_36_is_not_81` | 1163 | 0 | 0 | OK |
| `am09_fixed_e_is_a_parameter` | 1169 | 0 | 0 | OK |
| `gadd_is_not_a_ggm_op` | 1185 | 0 | 0 | OK |
| `gsub_is_not_a_ggm_op` | 1189 | 0 | 0 | OK |
| `gconst_is_not_a_ggm_op` | 1193 | 0 | 0 | OK |
| `gra_poly_construction_needs_add` | 1197 | 0 | 0 | OK |
| `generic_group_does_not_separate_rsa_from_srsa` | 1201 | 0 | 0 | OK |
| `ggm_mul_pin` | 1208 | 0 | 0 | OK |
...
| `rsa_solution_is_strong_RSA` | 102 | 0 | 0 | OK |
| `lambda_solves_strong_RSA` | 116 | 0 | 0 | OK |
| `strong_RSA_trivial_at_one` | 140 | 0 | 0 | OK |
| `rsa_trivial_at_one` | 148 | 0 | 0 | OK |
| `order_divides_annihilator` | 157 | 0 | 0 | OK |
| `order_divides_lambda` | 186 | 0 | 0 | OK |
| `one_sided_low_order_factors` | 214 | 0 | 0 | OK |
| `one_sided_low_order_is_factor` | 246 | 0 | 0 | OK |
| `adaptive_root_is_strong_RSA` | 259 | 0 | 0 | OK |
| `order_is_annihilator` | 270 | 0 | 0 | OK |
| `low_order_is_annihilator` | 279 | 0 | 0 | OK |
| `lambda_is_annihilator_on_units` | 288 | 0 | 0 | OK |
| `annihilator_plus_one_is_strong_RSA` | 301 | 0 | 0 | OK |
| `rsa_is_fractional_root` | 318 | 0 | 0 | OK |
| `strong_RSA_is_fractional_root` | 334 | 0 | 0 | OK |
| `annihilator_is_fractional_root_of_one` | 349 | 0 | 0 | OK |
| `ar_C_implies_strong_RSA` | 378 | 0 | 0 | OK |
| `ar_C_requires_C` | 387 | 0 | 0 | OK |
| `strong_RSA_is_ar_C_iff` | 392 | 0 | 0 | OK |
| `lambda_plus_one_11_17` | 403 | 0 | 0 | OK |
| `lambda_plus_one_11_17_not_prime` | 407 | 0 | 0 | OK |
| `lambda_solves_search_11_17` | 416 | 0 | 0 | OK |
| `search_lambda_plus_one_misses_prime_AR` | 427 | 0 | 0 | OK |
| `adaptive_root_known_product_breaks` | 445 | 0 | 0 | OK |
| `adaptive_root_smooth_power_breaks` | 461 | 0 | 0 | OK |
| `order_inverts_in_cyclic` | 485 | 0 | 0 | OK |
| `order_yields_strong_RSA` | 510 | 0 | 0 | OK |
| `gcd_powm_minus_1` | 536 | 0 | 0 | OK |
| `leftover_mismatch_factors` | 549 | 0 | 0 | OK |
...
| `pin_miller_walk_base2` | 135 | 0 | 0 | OK |
| `pin_miller_walk_not_at_g0` | 143 | 0 | 0 | OK |
| `miller_search_from_hit` | 171 | 0 | 0 | OK |
| `pin_miller_search` | 181 | 0 | 0 | OK |
| `pin_miller_search_in_range` | 190 | 0 | 0 | OK |
| `pin_miller_walk_liar_1` | 201 | 0 | 0 | OK |
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `is_order_unique` | 38 | 0 | 0 | OK |
| `no_smaller_order_sound` | 57 | 0 | 0 | OK |
| `is_order_by_vm` | 80 | 0 | 0 | OK |
| `powm_one_of_divide` | 92 | 0 | 0 | OK |
| `order_iff_divides` | 108 | 0 | 0 | OK |
| `order_exists_from_annihilator` | 130 | 0 | 0 | OK |
| `order_exists_prime` | 180 | 0 | 0 | OK |
| `order_exists_semiprime` | 194 | 0 | 0 | OK |
| `order_of_power` | 211 | 0 | 0 | OK |
| `lcm_orders_divides_lambda` | 273 | 0 | 0 | OK |
| `is_order_2_of` | 306 | 0 | 0 | OK |
| `minus1_order_2_rsa_test` | 320 | 0 | 0 | OK |
| `mixed67_order_2_rsa_test` | 326 | 0 | 0 | OK |
| `lcm_two_order2_not_lambda` | 332 | 0 | 0 | OK |
| `is_order_pin_g_p` | 343 | 0 | 0 | OK |
| `is_order_pin_g_q` | 348 | 0 | 0 | OK |
| `pin_unit_3_coprime` | 355 | 0 | 0 | OK |
| `powm_eq_1_iff_order_divides` | 361 | 0 | 0 | OK |
| `pow2_divides_pow2` | 372 | 0 | 0 | OK |
| `two_height_is_val2_ord` | 395 | 0 | 0 | OK |
| `order_2_mod_11` | 454 | 0 | 0 | OK |
| `order_2_mod_17` | 459 | 0 | 0 | OK |
| `two_height_independent_of_odd_multiple` | 466 | 0 | 0 | OK |
| `height_is_val2_ord_textbook` | 482 | 0 | 0 | OK |
| `zseq_length` | 519 | 0 | 0 | OK |
| `zseq_In_bounds` | 526 | 0 | 0 | OK |
| `zseq_Forall_distinct_head` | 539 | 0 | 0 | OK |
| `zseq_pairwise_distinct` | 559 | 0 | 0 | OK |
| `units_mod_prime_length` | 575 | 0 | 0 | OK |
| `units_mod_prime_In` | 579 | 0 | 0 | OK |
| `units_mod_prime_coprime` | 589 | 0 | 0 | OK |
| `units_mod_prime_distinct` | 601 | 0 | 0 | OK |
| `units_mod_prime_nonnil` | 611 | 0 | 0 | OK |
| `order_mul_coprime` | 619 | 0 | 0 | OK |
| `order_of_divisor_power` | 690 | 0 | 0 | OK |
| `order_lcm_attained` | 719 | 0 | 0 | OK |
| `exists_max_order_in` | 750 | 0 | 0 | OK |
| `zseq_In_interval` | 784 | 0 | 0 | OK |
| `unit_mod_in_list` | 797 | 0 | 0 | OK |
| `is_order_mod_base` | 818 | 0 | 0 | OK |
| `is_order_of_mod` | 832 | 0 | 0 | OK |
| `is_order_eq_mod` | 846 | 0 | 0 | OK |
| `primitive_root_exists` | 859 | 0 | 0 | OK |
| `order_semiprime_from_locals` | 925 | 0 | 0 | OK |
| `exists_unit_order_lambda` | 968 | 0 | 0 | OK |
| `is_order_pin_3_80` | 1004 | 0 | 0 | OK |
| `exists_unit_order_lambda_pin` | 1013 | 0 | 0 | OK |
| `pin_attains_lambda` | 1019 | 0 | 0 | OK |
| `orders_generate_lambda_pin` | 1028 | 0 | 0 | OK |
| `orders_attained_generate_lambda` | 1033 | 0 | 0 | OK |
| `mul_cancel_unit_mod` | 1055 | 0 | 0 | OK |
| `powm_eq_pow_cancel` | 1070 | 0 | 0 | OK |
| `powm_inj_lt_order` | 1094 | 0 | 0 | OK |
| `nodup_incl_le` | 1123 | 0 | 0 | OK |
| `powers_upto_length` | 1152 | 0 | 0 | OK |
| `powers_upto_In` | 1158 | 0 | 0 | OK |
| `powers_upto_NoDup` | 1171 | 0 | 0 | OK |
| `primitive_root_generates` | 1191 | 0 | 0 | OK |
...
| `pin187_N_pos` | 121 | 0 | 0 | OK |
| `pin187_N_gt_1` | 124 | 0 | 0 | OK |
| `pin187_p_neq_q` | 127 | 0 | 0 | OK |
| `pin187_p_lt_q` | 130 | 0 | 0 | OK |
| `pin187_p_prime` | 133 | 0 | 0 | OK |
| `pin187_q_prime` | 143 | 0 | 0 | OK |
| `pin1363_N_pos` | 211 | 0 | 0 | OK |
| `pin1363_N_gt_1` | 214 | 0 | 0 | OK |
| `pin1363_p_neq_q` | 217 | 0 | 0 | OK |
| `pin1363_p_lt_q` | 220 | 0 | 0 | OK |
| `pin1363_p_prime` | 223 | 0 | 0 | OK |
| `pin1363_q_prime` | 233 | 0 | 0 | OK |
| `pin2491_N_pos` | 301 | 0 | 0 | OK |
| `pin2491_N_gt_1` | 304 | 0 | 0 | OK |
| `pin2491_p_neq_q` | 307 | 0 | 0 | OK |
| `pin2491_p_lt_q` | 310 | 0 | 0 | OK |
| `pin2491_p_prime` | 313 | 0 | 0 | OK |
| `pin2491_q_prime` | 323 | 0 | 0 | OK |
| `pin_209_q_prime` | 387 | 0 | 0 | OK |
| `pin_p_prime` | 458 | 0 | 0 | OK |
| `pin_q_prime` | 461 | 0 | 0 | OK |
| `pin_N_pos` | 464 | 0 | 0 | OK |
| `pin_N_gt_1` | 467 | 0 | 0 | OK |
| `pin_p_neq_q` | 470 | 0 | 0 | OK |
| `pin_p_lt_q` | 473 | 0 | 0 | OK |
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `pratt_2_prime` | 53 | 0 | 0 | OK |
| `pratt_fermat_side` | 58 | 0 | 0 | OK |
| `duality_unique_order_2_on_prime` | 71 | 0 | 0 | OK |
| `prime_5` | 125 | 0 | 0 | OK |
| `pratt_generator_ok_11` | 133 | 0 | 0 | OK |
| `pratt_factors_ok_11` | 143 | 0 | 0 | OK |
| `pratt_qs_prime_11` | 147 | 0 | 0 | OK |
| `fold_left_mul_mul_acc` | 164 | 0 | 0 | OK |
| `fold_left_mul_acc` | 173 | 0 | 0 | OK |
| `fold_left_mul_cons` | 183 | 0 | 0 | OK |
| `prime_divides_fold_mul` | 194 | 0 | 0 | OK |
| `pratt_factors_cover_prime` | 212 | 0 | 0 | OK |
| `pratt_11_inhabited` | 259 | 0 | 0 | OK |
| `pratt_11_verified` | 262 | 0 | 0 | OK |
| `prime_3` | 274 | 0 | 0 | OK |
| `prime_31` | 282 | 0 | 0 | OK |
| `pratt_generator_ok_31` | 292 | 0 | 0 | OK |
| `pratt_factors_ok_31` | 301 | 0 | 0 | OK |
| `pratt_qs_prime_31` | 305 | 0 | 0 | OK |
| `pratt_31_inhabited` | 326 | 0 | 0 | OK |
| `pratt_31_verified` | 329 | 0 | 0 | OK |
| `pratt_gcd_ok_of_prime` | 347 | 0 | 0 | OK |
| `pratt_gcd_ok_11` | 374 | 0 | 0 | OK |
| `pratt_gcd_ok_31` | 380 | 0 | 0 | OK |
| `reduced_minus1_mod` | 392 | 0 | 0 | OK |
| `powm_one_of_divisor` | 407 | 0 | 0 | OK |
| `pratt_coprime_of_fermat` | 431 | 0 | 0 | OK |
| `divide_le_pos` | 469 | 0 | 0 | OK |
| `coprime_of_divisor` | 481 | 0 | 0 | OK |
| `powm_one_of_multiple` | 498 | 0 | 0 | OK |
| `powm_gcd_exp` | 519 | 0 | 0 | OK |
| `pratt_gcd_ok_not_one_mod_factor` | 561 | 0 | 0 | OK |
| `pratt_verified_implies_prime` | 596 | 0 | 0 | OK |
| `pratt_inhabit_of_certs` | 660 | 0 | 0 | OK |
| `pratt_verifier` | 670 | 0 | 0 | OK |
| `pratt_11_sound` | 686 | 0 | 0 | OK |
| `pratt_31_sound` | 693 | 0 | 0 | OK |
...
| `rabin_oracle_nonassociate_factors` | 272 | 0 | 0 | OK |
| `rw_verify_of_root` | 308 | 0 | 0 | OK |
| `kg_rw_implies_blum` | 319 | 0 | 0 | OK |
| `kg_rw_pminus1_almost_odd` | 327 | 0 | 0 | OK |
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `residual_solver_reduced_fixed_e_extracts_and_factors` | 39 | 0 | 0 | OK |
| `pin_e7_solver_extracts_and_factors` | 79 | 0 | 0 | OK |
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `pin_mul_mod_range` | 35 | 0 | 0 | OK |
| `pin_mul_mod_coprime` | 39 | 0 | 0 | OK |
| `pin_trapdoor_solver_x_homomorphic` | 62 | 0 | 0 | OK |
| `residual_x_homomorphic_constructs_factor` | 76 | 0 | 0 | OK |
| `rsa_inverter_reduced_units_constructs_factor_pin` | 95 | 0 | 0 | OK |
| `strong_rsa_solver_annihilator_e_constructs_factor` | 118 | 0 | 0 | OK |
| `pin_lambda_strong_solver_annihilator_e` | 135 | 0 | 0 | OK |
| `pin_lambda_strong_solver_millers_from_e_minus_1` | 141 | 0 | 0 | OK |
| `residual_leaf_not_annihilator_e` | 149 | 0 | 0 | OK |
| `residual_solver_not_annihilator_e` | 157 | 0 | 0 | OK |
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `Z_pow_3_mul` | 32 | 0 | 0 | OK |
| `prime_divides_cube` | 40 | 0 | 0 | OK |
| `gcd_prime_is_1_or_p` | 55 | 0 | 0 | OK |
| `divide_eq_pos` | 73 | 0 | 0 | OK |
| `gcd_eq_n_of_div` | 85 | 0 | 0 | OK |
| `pin_divide_N_cases` | 96 | 0 | 0 | OK |
| `pin_proper_gcd_is_p_or_q` | 138 | 0 | 0 | OK |
| `mod_cbrt_nonunit_factors` | 160 | 0 | 0 | OK |
| `pin_cbrt_p_rel` | 229 | 0 | 0 | OK |
| `pin_cbrt_p_gcd` | 233 | 0 | 0 | OK |
| `pin_cbrt_p_factors` | 237 | 0 | 0 | OK |
| `pin_cbrt_p_neq_p` | 244 | 0 | 0 | OK |
| `integer_cube_root_p_miss` | 248 | 0 | 0 | OK |
| `integer_cbrt_p_neq_mod_cbrt_p` | 252 | 0 | 0 | OK |
| `pin_cbrt_2p_rel` | 256 | 0 | 0 | OK |
| `pin_cbrt_2p_factors` | 260 | 0 | 0 | OK |
| `pin_cbrt_0_rel` | 265 | 0 | 0 | OK |
| `pin_cbrt_0_gcd_is_N` | 269 | 0 | 0 | OK |
| `pin_cbrt_y_is_x` | 273 | 0 | 0 | OK |
| `pin_cbrt_y_unit` | 277 | 0 | 0 | OK |
| `mod_cbrt_unit_coprime` | 283 | 0 | 0 | OK |
| `residual_leaf_y_is_residue` | 295 | 0 | 0 | OK |
| `pin_N_plus_1_not_a_leaf` | 307 | 0 | 0 | OK |
| `mod_cbrt_unit_is_residual_leaf` | 315 | 0 | 0 | OK |
| `pin_x_is_residual_leaf_of_y` | 333 | 0 | 0 | OK |
| `trapdoor_inhabits_residual_leaf` | 342 | 0 | 0 | OK |
| `pin_trapdoor_solver_returns_e` | 378 | 0 | 0 | OK |
| `residual_solver_reduced_pin_e_is_mod_cbrt` | 382 | 0 | 0 | OK |
| `residual_solver_reduced_pin_e_is_trapdoor` | 398 | 0 | 0 | OK |
| `residual_solver_reduced_pin_e_constructs_factor` | 420 | 0 | 0 | OK |
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `is_order_pin_y_40` | 30 | 0 | 0 | OK |
| `order_yields_residual_sRSA` | 40 | 0 | 0 | OK |
| `order_yields_residual_pin` | 62 | 0 | 0 | OK |
| `order_invert_pin_is_cube_root` | 78 | 0 | 0 | OK |
| `residual_mismatch_factors` | 94 | 0 | 0 | OK |
| `leftover_x_one_sided_pin` | 106 | 0 | 0 | OK |
| `leftover_x_mismatch_factors_pin` | 115 | 0 | 0 | OK |
| `residual_mismatch_factors_pin` | 124 | 0 | 0 | OK |
| `leftover_y_one_sided_pin` | 136 | 0 | 0 | OK |
| `order_mismatch_factors_pin` | 145 | 0 | 0 | OK |
| `leftover_77_one_sided` | 154 | 0 | 0 | OK |
| `leftover_77_mismatch_factors` | 163 | 0 | 0 | OK |
| `matching_247_not_one_sided` | 176 | 0 | 0 | OK |
| `matching_247_gcd_not_proper` | 184 | 0 | 0 | OK |
| `matching_247_two_sided_gcd_is_N` | 194 | 0 | 0 | OK |
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `cong_1_mod_p_0_mod_q_gcd` | 78 | 0 | 0 | OK |
| `crt_binomial_eval` | 112 | 0 | 0 | OK |
| `crt_binomial_mod_p` | 125 | 0 | 0 | OK |
| `crt_binomial_mod_q` | 146 | 0 | 0 | OK |
| `local_eth_root` | 167 | 0 | 0 | OK |
| `crt_binomial_inverts_units` | 195 | 0 | 0 | OK |
| `pin_root_ca_mod` | 238 | 0 | 0 | OK |
| `pin_root_cb_mod` | 242 | 0 | 0 | OK |
| `pin_inv3_local` | 246 | 0 | 0 | OK |
| `pin_root_ca_splits` | 251 | 0 | 0 | OK |
| `pin_root_cb_splits` | 264 | 0 | 0 | OK |
| `pin_crt_binomial_inverts_units` | 277 | 0 | 0 | OK |
| `pin_crt_binomial_eval_unit` | 300 | 0 | 0 | OK |
| `pin_ed_minus_1_divides_lam` | 313 | 0 | 0 | OK |
| `pin_powm_ed` | 322 | 0 | 0 | OK |
| `pin_unique_unit_eth_root` | 338 | 0 | 0 | OK |
| `pin_crt_binomial_at_y` | 350 | 0 | 0 | OK |
| `pin_crt_binomial_residual` | 362 | 0 | 0 | OK |
| `pin_crt_binomial_degree` | 369 | 0 | 0 | OK |
| `pin_crt_binomial_outside_window` | 373 | 0 | 0 | OK |
| `pin_crt_binomial_coeff_da` | 378 | 0 | 0 | OK |
| `pin_crt_binomial_coeff_db` | 382 | 0 | 0 | OK |
| `pin_trapdoor_monomial_eval` | 390 | 0 | 0 | OK |
| `pin_trapdoor_ed_inv` | 398 | 0 | 0 | OK |
| `pin_powm_de` | 402 | 0 | 0 | OK |
| `pin_trapdoor_monomial_inverts_units` | 419 | 0 | 0 | OK |
| `pin_trapdoor_monomial_at_y` | 427 | 0 | 0 | OK |
| `pin_trapdoor_monomial_degree` | 431 | 0 | 0 | OK |
| `pin_trapdoor_monomial_leading` | 435 | 0 | 0 | OK |
| `pin_trapdoor_degree_is_d` | 445 | 0 | 0 | OK |
| `pin_trapdoor_monomial_outside_window` | 452 | 0 | 0 | OK |
| `pin_root_polys_agree_on_units` | 459 | 0 | 0 | OK |
| `root_poly_eval_coprime` | 479 | 0 | 0 | OK |
| `all_units_root_poly_is_trapdoor_map` | 493 | 0 | 0 | OK |
| `all_units_root_poly_eval_g` | 514 | 0 | 0 | OK |
| `pin_trapdoor_monomial_is_trapdoor_map` | 524 | 0 | 0 | OK |
| `pin_crt_binomial_neq_monomial` | 534 | 0 | 0 | OK |
| `pin_crt_binomial_inverts_2` | 544 | 0 | 0 | OK |
| `unique_eth_root_mod_prime` | 570 | 0 | 0 | OK |
| `pin_Fq_units_of_N_length` | 596 | 0 | 0 | OK |
| `pairwise_distinct_mod_filter` | 600 | 0 | 0 | OK |
| `pin_Fq_units_of_N_distinct` | 618 | 0 | 0 | OK |
| `pin_Fq_units_of_N_coprime` | 625 | 0 | 0 | OK |
| `zseq_NoDup` | 642 | 0 | 0 | OK |
| `filter_neq_id` | 653 | 0 | 0 | OK |
| `filter_neq_length_in` | 665 | 0 | 0 | OK |
| `units_mod_prime_contains` | 683 | 0 | 0 | OK |
| `fq_units_of_N_length` | 690 | 0 | 0 | OK |
| `fq_units_of_N_distinct` | 709 | 0 | 0 | OK |
| `fq_units_of_N_coprime` | 718 | 0 | 0 | OK |
| `fq_units_or_p` | 746 | 0 | 0 | OK |
| `fp_units_of_N_coprime` | 759 | 0 | 0 | OK |
| `two_coprime_odd_primes` | 779 | 0 | 0 | OK |
| `pin_inv3_q_lt_window` | 795 | 0 | 0 | OK |
| `nth_poly_sub` | 799 | 0 | 0 | OK |
| `poly_degree_sub_le` | 807 | 0 | 0 | OK |
| `mod_product_r` | 818 | 0 | 0 | OK |
| `mod_product_l` | 830 | 0 | 0 | OK |
| `short_root_local_mod_q` | 836 | 0 | 0 | OK |
| `short_root_diff_vanishes` | 876 | 0 | 0 | OK |
| `short_root_q_divides_diff` | 898 | 0 | 0 | OK |
| `poly_eval_all_div` | 917 | 0 | 0 | OK |
| `poly_eval_single_support` | 931 | 0 | 0 | OK |
| `pin_two_pow_dbe_neq_2` | 963 | 0 | 0 | OK |
| `gcd_q_not_p` | 967 | 0 | 0 | OK |
| `powm_div_cong` | 994 | 0 | 0 | OK |
| `finite_support_cases` | 1008 | 0 | 0 | OK |
| `short_root_local_at_q` | 1032 | 0 | 0 | OK |
| `short_root_local_at_p` | 1068 | 0 | 0 | OK |
| `short_root_diff_vanishes_semiprime` | 1104 | 0 | 0 | OK |
| `short_root_q_divides_diff_semiprime` | 1136 | 0 | 0 | OK |
| `short_root_poly_coeff_splits` | 1166 | 0 | 0 | OK |
| `no_root_poly_below_dq` | 1262 | 0 | 0 | OK |
| `short_root_poly_some_coeff_splits` | 1289 | 0 | 0 | OK |
| `pin_crt_root_poly_is_short` | 1307 | 0 | 0 | OK |
| `pin_crt_root_poly_short_splits` | 1311 | 0 | 0 | OK |
| `no_root_poly_deg_lt_dq` | 1323 | 0 | 0 | OK |
| `pin_Xn_dp_does_not_invert_all_units` | 1339 | 0 | 0 | OK |
| `nodiv_gra_short_dq_splits` | 1350 | 0 | 0 | OK |
| `nodiv_identity_bound_lt_dq` | 1372 | 0 | 0 | OK |
| `nodiv_square_bound_lt_dq` | 1377 | 0 | 0 | OK |
| `trapdoor_monomial_inverts_all_units` | 1393 | 0 | 0 | OK |
| `monomial_all_units_invert_is_trapdoor` | 1421 | 0 | 0 | OK |
| `pin_d_monomial_is_trapdoor` | 1462 | 0 | 0 | OK |
| `pin_dp_monomial_not_trapdoor` | 1466 | 0 | 0 | OK |
| `pin_dq_monomial_not_trapdoor` | 1470 | 0 | 0 | OK |
| `pin_d_plus_lam_is_trapdoor` | 1474 | 0 | 0 | OK |
| `pin_d_plus_2lam_is_trapdoor` | 1478 | 0 | 0 | OK |
| `pin_trapdoor_k_M_pos` | 1482 | 0 | 0 | OK |
| `monomial_all_units_invert_miller` | 1495 | 0 | 0 | OK |
| `pin_miller_from_d_plus_lam` | 1526 | 0 | 0 | OK |
| `pin_base2_height_p_at_35` | 1548 | 0 | 0 | OK |
| `pin_base2_height_q_at_35` | 1556 | 0 | 0 | OK |
| `pin_odd_part_d_plus_2lam` | 1566 | 0 | 0 | OK |
| `pin_miller_from_d_plus_2lam` | 1570 | 0 | 0 | OK |
| `pin_d_mod_pminus1` | 1594 | 0 | 0 | OK |
| `pin_d_mod_qminus1` | 1598 | 0 | 0 | OK |
| `pin_inv3_p_is_crt_dp` | 1602 | 0 | 0 | OK |
| `pin_inv3_q_is_crt_dq` | 1606 | 0 | 0 | OK |
| `pin_local_inverses_recover_d` | 1610 | 0 | 0 | OK |
| `pin_local_inv_unique_p` | 1628 | 0 | 0 | OK |
| `pin_local_inv_unique_q` | 1640 | 0 | 0 | OK |
| `pin_mid_root_poly_degree` | 1661 | 0 | 0 | OK |
| `pin_mid_root_poly_in_window` | 1665 | 0 | 0 | OK |
| `pin_mid_root_poly_inverts_units` | 1669 | 0 | 0 | OK |
| `pin_mid_root_poly_splits` | 1683 | 0 | 0 | OK |
| `pin_p_lt_q` | 1698 | 0 | 0 | OK |
| `pin_Fp_units_of_N_length` | 1703 | 0 | 0 | OK |
| `pin_Fp_units_of_N_distinct` | 1707 | 0 | 0 | OK |
| `pin_Fp_units_of_N_coprime` | 1711 | 0 | 0 | OK |
| `short_root_local_mod_p` | 1726 | 0 | 0 | OK |
| `invert_all_units_local_p` | 1766 | 0 | 0 | OK |
| `invert_all_units_local_q` | 1777 | 0 | 0 | OK |
| `powm_reduce_period` | 1796 | 0 | 0 | OK |
| `nth_map_seq_Z` | 1832 | 0 | 0 | OK |
| `nth_poly_fold` | 1846 | 0 | 0 | OK |
| `poly_fold_length` | 1857 | 0 | 0 | OK |
| `poly_degree_fold_lt` | 1863 | 0 | 0 | OK |
| `map_plus_is_poly_add` | 1878 | 0 | 0 | OK |
| `map_seq_succ` | 1888 | 0 | 0 | OK |
| `poly_eval_map_seq_S` | 1898 | 0 | 0 | OK |
| `poly_eval_zeros_seq` | 1909 | 0 | 0 | OK |
| `poly_eval_delta_seq` | 1918 | 0 | 0 | OK |
| `poly_eval_from_scale` | 1949 | 0 | 0 | OK |
| `poly_eval_from_0` | 1960 | 0 | 0 | OK |
| `poly_eval_fold_from` | 1966 | 0 | 0 | OK |
| `poly_eval_fold_mod` | 2017 | 0 | 0 | OK |
| `pin_inv3_p_lt_pminus1` | 2030 | 0 | 0 | OK |
| `invert_fold_p_diff_vanishes` | 2034 | 0 | 0 | OK |
| `invert_all_units_fold_p` | 2068 | 0 | 0 | OK |
| `invert_all_units_fold_p_is_local_monomial` | 2093 | 0 | 0 | OK |
| `gcd_add_mul` | 2128 | 0 | 0 | OK |
| `pin_fermat_extra_divides_N` | 2140 | 0 | 0 | OK |
| `pin_fermat_root_poly_inverts_units` | 2163 | 0 | 0 | OK |
| `pin_fermat_root_poly_degree` | 2180 | 0 | 0 | OK |
| `pin_fermat_root_poly_splits` | 2184 | 0 | 0 | OK |
| `pin_gcd_add_mul_N` | 2194 | 0 | 0 | OK |
| `pin_inv3_q_lt_qminus1` | 2204 | 0 | 0 | OK |
| `invert_fold_q_diff_vanishes` | 2208 | 0 | 0 | OK |
| `invert_all_units_fold_q_eval` | 2244 | 0 | 0 | OK |
| `poly_degree_below_if_high_zero` | 2277 | 0 | 0 | OK |
| `pin_inv3_q_neq_qminus2` | 2292 | 0 | 0 | OK |
| `invert_all_units_fold_q_top_zero` | 2296 | 0 | 0 | OK |
| `invert_all_units_fold_q_is_local_monomial` | 2370 | 0 | 0 | OK |
| `invert_all_units_monomial_degree_mod_lam` | 2405 | 0 | 0 | OK |
| `poly_eval_cong` | 2426 | 0 | 0 | OK |
| `poly_eval_app` | 2443 | 0 | 0 | OK |
| `map_mul_length` | 2457 | 0 | 0 | OK |
| `geo_kernel_length` | 2469 | 0 | 0 | OK |
| `geo_kernel_identity` | 2478 | 0 | 0 | OK |
| `geo_kernel_at_base` | 2500 | 0 | 0 | OK |
| `p_plus_q_coprime` | 2526 | 0 | 0 | OK |
| `p_plus_q_mod_q` | 2546 | 0 | 0 | OK |
| `pin_p_plus_q_coprime` | 2553 | 0 | 0 | OK |
| `pin_p_plus_q_mod_q` | 2561 | 0 | 0 | OK |
| `pin_geo_kernel_vanishes` | 2570 | 0 | 0 | OK |
| `pin_geo_kernel_at_p_nonzero` | 2611 | 0 | 0 | OK |
| `pin_p_Kp_mod_q_nonzero` | 2615 | 0 | 0 | OK |
| `pin_geo_kernel_at_2_mod_p` | 2619 | 0 | 0 | OK |
| `pin_two_pow_qminus2_mod_p_nonzero` | 2623 | 0 | 0 | OK |
| `pin_binomial_plus_kernel_misses_lift` | 2630 | 0 | 0 | OK |
| `pin_Fq_units_or_p` | 2644 | 0 | 0 | OK |
| `invert_fold_q_at_lift` | 2657 | 0 | 0 | OK |
| `invert_fold_q_at_p` | 2722 | 0 | 0 | OK |
| `invert_fold_q_diff_vanishes_all` | 2735 | 0 | 0 | OK |
| `invert_all_units_fold_q` | 2752 | 0 | 0 | OK |
| `invert_all_units_fold_q_classes` | 2777 | 0 | 0 | OK |
| `invert_fold_p_diff_vanishes_semiprime` | 2804 | 0 | 0 | OK |
| `invert_all_units_fold_p_semiprime` | 2847 | 0 | 0 | OK |
| `invert_all_units_fold_p_classes_semiprime` | 2882 | 0 | 0 | OK |
| `invert_fold_q_diff_vanishes_semiprime` | 2922 | 0 | 0 | OK |
| `invert_fold_q_at_lift_semiprime` | 2968 | 0 | 0 | OK |
| `invert_fold_q_diff_vanishes_all_semiprime` | 3032 | 0 | 0 | OK |
| `invert_all_units_fold_q_classes_semiprime` | 3062 | 0 | 0 | OK |
| `invert_all_units_folds_local_monomials` | 3132 | 0 | 0 | OK |
| `invert_all_units_both_folds_are_local_monomials` | 3165 | 0 | 0 | OK |
| `invert_all_units_fold_degrees_crt_d` | 3187 | 0 | 0 | OK |
| `p_plus_k_q_mod_q` | 3202 | 0 | 0 | OK |
| `p_plus_k_q_coprime` | 3210 | 0 | 0 | OK |
| `pin_p_plus_2q_coprime` | 3232 | 0 | 0 | OK |
| `pin_p_plus_2q_mod_q` | 3241 | 0 | 0 | OK |
| `pin_p_plus_pq_shares_p` | 3247 | 0 | 0 | OK |
| `invert_fold_q_at_2q` | 3251 | 0 | 0 | OK |
| `geo_kernel_nth` | 3271 | 0 | 0 | OK |
| `geo_kernel_degree` | 3303 | 0 | 0 | OK |
| `geo_kernel_vanishes_semiprime` | 3321 | 0 | 0 | OK |
| `geo_kernel_inv_mod_semiprime` | 3363 | 0 | 0 | OK |
| `geo_kernel_at_2_mod_odd` | 3391 | 0 | 0 | OK |
| `pin_geo_kernel_degree` | 3435 | 0 | 0 | OK |
| `pin_geo_kernel_leading` | 3441 | 0 | 0 | OK |
| `pin_geo_kernel_lower_div_p` | 3450 | 0 | 0 | OK |
| `pin_geo_kernel_plus_q_cong` | 3463 | 0 | 0 | OK |
| `pin_crt_binomial_both_folds` | 3481 | 0 | 0 | OK |
| `poly_degree_gt_nth_zero` | 3502 | 0 | 0 | OK |
| `leftover_kernel_span_mod_q` | 3510 | 0 | 0 | OK |
| `leftover_monic_is_geo_kernel` | 3545 | 0 | 0 | OK |
| `leftover_kernel_exists_scalar_mod_q` | 3590 | 0 | 0 | OK |
| `leftover_kernel_span` | 3623 | 0 | 0 | OK |
| `leftover_monic_is_kernel` | 3639 | 0 | 0 | OK |
| `pin_geo_kernel_inv_mod` | 3654 | 0 | 0 | OK |
| `leftover_kernel_exists_scalar` | 3662 | 0 | 0 | OK |
| `pin_ck_agrees_canonical` | 3687 | 0 | 0 | OK |
| `pin_ck_extra_at_lift` | 3705 | 0 | 0 | OK |
| `pin_ck_extra_at_2_mod_p` | 3726 | 0 | 0 | OK |
| `poly_eval_plus_N_mul_inverts` | 3752 | 0 | 0 | OK |
| `invert_all_units_plus_c_kernel_iff` | 3767 | 0 | 0 | OK |
| `pin_binomial_plus_N_kernel_inverts` | 3889 | 0 | 0 | OK |
| `pin_binomial_plus_p_kernel_misses_lift` | 3902 | 0 | 0 | OK |
| `pin_binomial_plus_q_kernel_misses_2` | 3936 | 0 | 0 | OK |
| `class_sum_from_add` | 3971 | 0 | 0 | OK |
| `class_sum_from_map_mul` | 3985 | 0 | 0 | OK |
| `class_sum_poly_sub` | 3995 | 0 | 0 | OK |
| `invert_all_units_diff_fold_p_zero` | 4004 | 0 | 0 | OK |
| `invert_all_units_diff_fold_q_zero` | 4021 | 0 | 0 | OK |
| `pin_NX20_root_poly_inverts` | 4041 | 0 | 0 | OK |
| `pin_crt_vs_NX20_diff_folds_zero` | 4055 | 0 | 0 | OK |
| `pin_trapdoor_monomial_poly_inverts` | 4075 | 0 | 0 | OK |
| `pin_crt_vs_monomial_diff_folds_zero` | 4087 | 0 | 0 | OK |
| `mul_cancel_mod_unit_poly` | 4113 | 0 | 0 | OK |
| `dlog_search_correct` | 4142 | 0 | 0 | OK |
| `dlog_search_mod` | 4173 | 0 | 0 | OK |
| `pin_g_powm_coprime` | 4187 | 0 | 0 | OK |
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `pin_lambda_strong_solver_outputs_never_proper_gcd` | 55 | 0 | 0 | OK |
| `pin_lam_even` | 69 | 0 | 0 | OK |
| `residual_shaped_e_plus_k_lam` | 72 | 0 | 0 | OK |
| `unit_powm_plus_k_lam` | 96 | 0 | 0 | OK |
| `residual_leaf_plus_k_lam` | 114 | 0 | 0 | OK |
| `pin_e_plus_lam_residual` | 136 | 0 | 0 | OK |
| `mul_cancel_mod_unit` | 150 | 0 | 0 | OK |
| `same_unit_x_two_exponents_annihilates` | 167 | 0 | 0 | OK |
| `powm_one_gcd_is_N` | 189 | 0 | 0 | OK |
| `pin_x_lam_powm_one` | 202 | 0 | 0 | OK |
| `pin_x_lam_gcd_is_N` | 206 | 0 | 0 | OK |
| `pin_e7_minus_pin_e_does_not_miller` | 216 | 0 | 0 | OK |
| `pin_base2_height_p_at_odd_part_of_lam_multiple` | 229 | 0 | 0 | OK |
| `pin_base2_height_q_at_odd_part_of_lam_multiple` | 248 | 0 | 0 | OK |
| `pin_miller_from_lambda_multiple` | 266 | 0 | 0 | OK |
| `pin_miller_from_lam_factors` | 300 | 0 | 0 | OK |
| `pin_miller_from_2lam_factors` | 307 | 0 | 0 | OK |
| `pin_ed_minus_1_is_lam` | 315 | 0 | 0 | OK |
| `pin_inv7_mod_lam` | 325 | 0 | 0 | OK |
| `pin_y_to_23` | 329 | 0 | 0 | OK |
| `pin_e7_residual` | 333 | 0 | 0 | OK |
| `pin_e7_x_neq_pin_x` | 344 | 0 | 0 | OK |
| `pin_e7_not_cong_pin_e` | 348 | 0 | 0 | OK |
| `residual_e_cong_pin_e_ge` | 365 | 0 | 0 | OK |
| `residual_solver_reduced_e_cong_x_is_trapdoor` | 374 | 0 | 0 | OK |
| `residual_solver_reduced_e_cong_nonminimal_constructs_factor` | 402 | 0 | 0 | OK |
| `residual_solver_reduced_e_cong_constructs_factor` | 421 | 0 | 0 | OK |
...
| `srsa_residual_pin` | 257 | 0 | 0 | OK |
| `srsa_residual_pin187` | 268 | 0 | 0 | OK |
| `srsa_fixed_e_rerand` | 311 | 0 | 0 | OK |
| `srsa_fixed_e_rerand_pin` | 324 | 0 | 0 | OK |
| `srsa_poly_e_not_rerand_invariant` | 331 | 0 | 0 | OK |
| `srsa_related_y_square` | 337 | 0 | 0 | OK |
| `srsa_related_pin` | 353 | 0 | 0 | OK |
| `srsa_sagm_handle_unit` | 359 | 0 | 0 | OK |
| `srsa_sagm_lambda_type_peel` | 364 | 0 | 0 | OK |
| `srsa_sagm_product_reused` | 369 | 0 | 0 | OK |
| `srsa_sqrt1_120_splits` | 379 | 0 | 0 | OK |
| `srsa_minus1_no_split` | 385 | 0 | 0 | OK |
| `srsa_120_plus_1` | 390 | 0 | 0 | OK |
| `srsa_miller_66` | 394 | 0 | 0 | OK |
| `srsa_four_sqrt1` | 398 | 0 | 0 | OK |
...
| `rsa_inverter_recovers_message` | 611 | 0 | 0 | OK |
| `sign_hom_3` | 643 | 0 | 0 | OK |
| `sign_of_msg_product_one` | 659 | 0 | 0 | OK |
| `sign_weighted_commute` | 676 | 0 | 0 | OK |
| `sign_weighted_product` | 690 | 0 | 0 | OK |
| `euler_sign_of_pm1` | 717 | 0 | 0 | OK |
| `euler_sign_sq` | 734 | 0 | 0 | OK |
| `other_legendre_from_product` | 745 | 0 | 0 | OK |
| `cipher_jacobi_eq_message` | 758 | 0 | 0 | OK |
| `onesided_plain_one_factors` | 793 | 0 | 0 | OK |
| `ctor_slot_mod_r_need_not_factor` | 808 | 0 | 0 | OK |
| `cube_below_N` | 828 | 0 | 0 | OK |
| `e3_small_cube_verifies` | 843 | 0 | 0 | OK |
| `bleiche_wrap_interval` | 858 | 0 | 0 | OK |
| `pkcs15_prefix_is_type2` | 884 | 0 | 0 | OK |
| `manger_is_stricter_than_type2` | 894 | 0 | 0 | OK |
