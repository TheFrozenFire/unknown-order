...
**Headline:** all 2591 named results are **Closed under the global context** — **0 load-bearing axioms** across the whole corpus.

Captured for 2591 results across 119 files.
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `cong_1_mod_p_0_mod_q_gcd` | 71 | 0 | 0 | OK |
| `crt_binomial_eval` | 105 | 0 | 0 | OK |
| `crt_binomial_mod_p` | 118 | 0 | 0 | OK |
| `crt_binomial_mod_q` | 139 | 0 | 0 | OK |
| `local_eth_root` | 160 | 0 | 0 | OK |
| `crt_binomial_inverts_units` | 188 | 0 | 0 | OK |
| `pin_root_ca_mod` | 231 | 0 | 0 | OK |
| `pin_root_cb_mod` | 235 | 0 | 0 | OK |
| `pin_inv3_local` | 239 | 0 | 0 | OK |
| `pin_root_ca_splits` | 244 | 0 | 0 | OK |
| `pin_root_cb_splits` | 257 | 0 | 0 | OK |
| `pin_crt_binomial_inverts_units` | 270 | 0 | 0 | OK |
| `pin_crt_binomial_eval_unit` | 293 | 0 | 0 | OK |
| `pin_ed_minus_1_divides_lam` | 306 | 0 | 0 | OK |
| `pin_powm_ed` | 315 | 0 | 0 | OK |
| `pin_unique_unit_eth_root` | 331 | 0 | 0 | OK |
| `pin_crt_binomial_at_y` | 343 | 0 | 0 | OK |
| `pin_crt_binomial_residual` | 355 | 0 | 0 | OK |
| `pin_crt_binomial_degree` | 362 | 0 | 0 | OK |
| `pin_crt_binomial_outside_window` | 366 | 0 | 0 | OK |
| `pin_crt_binomial_coeff_da` | 371 | 0 | 0 | OK |
| `pin_crt_binomial_coeff_db` | 375 | 0 | 0 | OK |
| `pin_trapdoor_monomial_eval` | 383 | 0 | 0 | OK |
| `pin_trapdoor_ed_inv` | 391 | 0 | 0 | OK |
| `pin_powm_de` | 395 | 0 | 0 | OK |
| `pin_trapdoor_monomial_inverts_units` | 412 | 0 | 0 | OK |
| `pin_trapdoor_monomial_at_y` | 420 | 0 | 0 | OK |
| `pin_trapdoor_monomial_degree` | 424 | 0 | 0 | OK |
| `pin_trapdoor_monomial_leading` | 428 | 0 | 0 | OK |
| `pin_trapdoor_degree_is_d` | 438 | 0 | 0 | OK |
| `pin_trapdoor_monomial_outside_window` | 445 | 0 | 0 | OK |
| `pin_root_polys_agree_on_units` | 452 | 0 | 0 | OK |
| `root_poly_eval_coprime` | 472 | 0 | 0 | OK |
| `all_units_root_poly_is_trapdoor_map` | 486 | 0 | 0 | OK |
| `all_units_root_poly_eval_g` | 507 | 0 | 0 | OK |
| `pin_trapdoor_monomial_is_trapdoor_map` | 517 | 0 | 0 | OK |
| `pin_crt_binomial_neq_monomial` | 527 | 0 | 0 | OK |
| `pin_crt_binomial_inverts_2` | 537 | 0 | 0 | OK |
| `unique_eth_root_mod_prime` | 560 | 0 | 0 | OK |
| `pin_Fq_units_of_N_length` | 584 | 0 | 0 | OK |
| `pairwise_distinct_mod_filter` | 588 | 0 | 0 | OK |
| `pin_Fq_units_of_N_distinct` | 606 | 0 | 0 | OK |
| `pin_Fq_units_of_N_coprime` | 613 | 0 | 0 | OK |
| `pin_inv3_q_lt_window` | 630 | 0 | 0 | OK |
| `nth_poly_sub` | 634 | 0 | 0 | OK |
| `poly_degree_sub_le` | 642 | 0 | 0 | OK |
| `mod_product_r` | 653 | 0 | 0 | OK |
| `mod_product_l` | 665 | 0 | 0 | OK |
| `short_root_local_mod_q` | 671 | 0 | 0 | OK |
| `short_root_diff_vanishes` | 711 | 0 | 0 | OK |
| `short_root_q_divides_diff` | 733 | 0 | 0 | OK |
| `poly_eval_all_div` | 752 | 0 | 0 | OK |
| `poly_eval_single_support` | 766 | 0 | 0 | OK |
| `pin_two_pow_dbe_neq_2` | 798 | 0 | 0 | OK |
| `gcd_q_not_p` | 802 | 0 | 0 | OK |
| `powm_div_cong` | 829 | 0 | 0 | OK |
| `finite_support_cases` | 843 | 0 | 0 | OK |
| `short_root_poly_some_coeff_splits` | 867 | 0 | 0 | OK |
| `pin_crt_root_poly_is_short` | 951 | 0 | 0 | OK |
| `pin_crt_root_poly_short_splits` | 955 | 0 | 0 | OK |
| `no_root_poly_deg_lt_dq` | 967 | 0 | 0 | OK |
| `pin_Xn_dp_does_not_invert_all_units` | 984 | 0 | 0 | OK |
| `nodiv_gra_short_dq_splits` | 995 | 0 | 0 | OK |
| `nodiv_identity_bound_lt_dq` | 1017 | 0 | 0 | OK |
| `nodiv_square_bound_lt_dq` | 1022 | 0 | 0 | OK |
| `trapdoor_monomial_inverts_all_units` | 1038 | 0 | 0 | OK |
| `monomial_all_units_invert_is_trapdoor` | 1066 | 0 | 0 | OK |
| `pin_d_monomial_is_trapdoor` | 1107 | 0 | 0 | OK |
| `pin_dp_monomial_not_trapdoor` | 1111 | 0 | 0 | OK |
| `pin_dq_monomial_not_trapdoor` | 1115 | 0 | 0 | OK |
| `pin_d_plus_lam_is_trapdoor` | 1119 | 0 | 0 | OK |
| `pin_d_plus_2lam_is_trapdoor` | 1123 | 0 | 0 | OK |
| `pin_trapdoor_k_M_pos` | 1127 | 0 | 0 | OK |
| `monomial_all_units_invert_miller` | 1140 | 0 | 0 | OK |
| `pin_miller_from_d_plus_lam` | 1171 | 0 | 0 | OK |
| `pin_base2_height_p_at_35` | 1193 | 0 | 0 | OK |
| `pin_base2_height_q_at_35` | 1201 | 0 | 0 | OK |
| `pin_odd_part_d_plus_2lam` | 1211 | 0 | 0 | OK |
| `pin_miller_from_d_plus_2lam` | 1215 | 0 | 0 | OK |
| `pin_d_mod_pminus1` | 1239 | 0 | 0 | OK |
| `pin_d_mod_qminus1` | 1243 | 0 | 0 | OK |
| `pin_inv3_p_is_crt_dp` | 1247 | 0 | 0 | OK |
| `pin_inv3_q_is_crt_dq` | 1251 | 0 | 0 | OK |
| `pin_local_inverses_recover_d` | 1255 | 0 | 0 | OK |
| `pin_local_inv_unique_p` | 1273 | 0 | 0 | OK |
| `pin_local_inv_unique_q` | 1285 | 0 | 0 | OK |
| `pin_mid_root_poly_degree` | 1306 | 0 | 0 | OK |
| `pin_mid_root_poly_in_window` | 1310 | 0 | 0 | OK |
| `pin_mid_root_poly_inverts_units` | 1314 | 0 | 0 | OK |
| `pin_mid_root_poly_splits` | 1328 | 0 | 0 | OK |
| `pin_p_lt_q` | 1343 | 0 | 0 | OK |
| `pin_Fp_units_of_N_length` | 1348 | 0 | 0 | OK |
| `pin_Fp_units_of_N_distinct` | 1352 | 0 | 0 | OK |
| `pin_Fp_units_of_N_coprime` | 1356 | 0 | 0 | OK |
| `short_root_local_mod_p` | 1371 | 0 | 0 | OK |
| `invert_all_units_local_p` | 1411 | 0 | 0 | OK |
| `invert_all_units_local_q` | 1422 | 0 | 0 | OK |
| `powm_reduce_period` | 1441 | 0 | 0 | OK |
| `nth_map_seq_Z` | 1477 | 0 | 0 | OK |
| `nth_poly_fold` | 1491 | 0 | 0 | OK |
| `poly_fold_length` | 1502 | 0 | 0 | OK |
| `poly_degree_fold_lt` | 1508 | 0 | 0 | OK |
| `map_plus_is_poly_add` | 1523 | 0 | 0 | OK |
| `map_seq_succ` | 1533 | 0 | 0 | OK |
| `poly_eval_map_seq_S` | 1543 | 0 | 0 | OK |
| `poly_eval_zeros_seq` | 1554 | 0 | 0 | OK |
| `poly_eval_delta_seq` | 1563 | 0 | 0 | OK |
| `poly_eval_from_scale` | 1594 | 0 | 0 | OK |
| `poly_eval_from_0` | 1605 | 0 | 0 | OK |
| `poly_eval_fold_from` | 1611 | 0 | 0 | OK |
| `poly_eval_fold_mod` | 1662 | 0 | 0 | OK |
| `pin_inv3_p_lt_pminus1` | 1675 | 0 | 0 | OK |
| `invert_fold_p_diff_vanishes` | 1679 | 0 | 0 | OK |
| `invert_all_units_fold_p` | 1713 | 0 | 0 | OK |
| `invert_all_units_fold_p_is_local_monomial` | 1738 | 0 | 0 | OK |
| `gcd_add_mul` | 1773 | 0 | 0 | OK |
| `pin_fermat_extra_divides_N` | 1785 | 0 | 0 | OK |
| `pin_fermat_root_poly_inverts_units` | 1808 | 0 | 0 | OK |
| `pin_fermat_root_poly_degree` | 1825 | 0 | 0 | OK |
| `pin_fermat_root_poly_splits` | 1829 | 0 | 0 | OK |
| `pin_gcd_add_mul_N` | 1839 | 0 | 0 | OK |
| `pin_inv3_q_lt_qminus1` | 1849 | 0 | 0 | OK |
| `invert_fold_q_diff_vanishes` | 1853 | 0 | 0 | OK |
| `invert_all_units_fold_q_eval` | 1889 | 0 | 0 | OK |
| `poly_degree_below_if_high_zero` | 1922 | 0 | 0 | OK |
| `pin_inv3_q_neq_qminus2` | 1937 | 0 | 0 | OK |
| `invert_all_units_fold_q_top_zero` | 1941 | 0 | 0 | OK |
| `invert_all_units_fold_q_is_local_monomial` | 2015 | 0 | 0 | OK |
| `invert_all_units_monomial_degree_mod_lam` | 2050 | 0 | 0 | OK |
| `poly_eval_cong` | 2071 | 0 | 0 | OK |
| `poly_eval_app` | 2088 | 0 | 0 | OK |
| `map_mul_length` | 2102 | 0 | 0 | OK |
| `geo_kernel_length` | 2114 | 0 | 0 | OK |
| `geo_kernel_identity` | 2123 | 0 | 0 | OK |
| `geo_kernel_at_base` | 2145 | 0 | 0 | OK |
| `p_plus_q_coprime` | 2171 | 0 | 0 | OK |
| `p_plus_q_mod_q` | 2191 | 0 | 0 | OK |
| `pin_p_plus_q_coprime` | 2198 | 0 | 0 | OK |
| `pin_p_plus_q_mod_q` | 2206 | 0 | 0 | OK |
| `pin_geo_kernel_vanishes` | 2215 | 0 | 0 | OK |
| `pin_geo_kernel_at_p_nonzero` | 2256 | 0 | 0 | OK |
| `pin_p_Kp_mod_q_nonzero` | 2260 | 0 | 0 | OK |
| `pin_geo_kernel_at_2_mod_p` | 2264 | 0 | 0 | OK |
| `pin_two_pow_qminus2_mod_p_nonzero` | 2268 | 0 | 0 | OK |
| `pin_binomial_plus_kernel_misses_lift` | 2275 | 0 | 0 | OK |
| `pin_Fq_units_or_p` | 2289 | 0 | 0 | OK |
| `invert_fold_q_at_lift` | 2302 | 0 | 0 | OK |
| `invert_fold_q_at_p` | 2367 | 0 | 0 | OK |
| `invert_fold_q_diff_vanishes_all` | 2380 | 0 | 0 | OK |
| `invert_all_units_fold_q` | 2397 | 0 | 0 | OK |
| `invert_all_units_fold_q_classes` | 2422 | 0 | 0 | OK |
| `invert_all_units_both_folds_are_local_monomials` | 2458 | 0 | 0 | OK |
| `invert_all_units_fold_degrees_crt_d` | 2474 | 0 | 0 | OK |
| `p_plus_k_q_mod_q` | 2489 | 0 | 0 | OK |
| `p_plus_k_q_coprime` | 2497 | 0 | 0 | OK |
| `pin_p_plus_2q_coprime` | 2519 | 0 | 0 | OK |
| `pin_p_plus_2q_mod_q` | 2528 | 0 | 0 | OK |
| `pin_p_plus_pq_shares_p` | 2534 | 0 | 0 | OK |
| `invert_fold_q_at_2q` | 2538 | 0 | 0 | OK |
| `geo_kernel_nth` | 2558 | 0 | 0 | OK |
| `pin_geo_kernel_degree` | 2590 | 0 | 0 | OK |
| `pin_geo_kernel_leading` | 2594 | 0 | 0 | OK |
| `pin_geo_kernel_lower_div_p` | 2603 | 0 | 0 | OK |
| `pin_geo_kernel_plus_q_cong` | 2616 | 0 | 0 | OK |
| `pin_crt_binomial_both_folds` | 2634 | 0 | 0 | OK |
| `poly_degree_gt_nth_zero` | 2653 | 0 | 0 | OK |
| `leftover_kernel_span` | 2661 | 0 | 0 | OK |
| `leftover_monic_is_kernel` | 2690 | 0 | 0 | OK |
| `pin_geo_kernel_inv_mod` | 2723 | 0 | 0 | OK |
| `leftover_kernel_exists_scalar` | 2727 | 0 | 0 | OK |
| `pin_ck_agrees_canonical` | 2762 | 0 | 0 | OK |
| `pin_ck_extra_at_lift` | 2780 | 0 | 0 | OK |
| `pin_ck_extra_at_2_mod_p` | 2801 | 0 | 0 | OK |
| `pin_binomial_plus_N_kernel_inverts` | 2827 | 0 | 0 | OK |
| `pin_binomial_plus_p_kernel_misses_lift` | 2842 | 0 | 0 | OK |
| `pin_binomial_plus_q_kernel_misses_2` | 2876 | 0 | 0 | OK |
| `class_sum_from_add` | 2909 | 0 | 0 | OK |
| `class_sum_from_map_mul` | 2923 | 0 | 0 | OK |
| `class_sum_poly_sub` | 2933 | 0 | 0 | OK |
| `invert_all_units_diff_fold_p_zero` | 2942 | 0 | 0 | OK |
| `invert_all_units_diff_fold_q_zero` | 2959 | 0 | 0 | OK |
| `pin_NX20_root_poly_inverts` | 2979 | 0 | 0 | OK |
| `pin_crt_vs_NX20_diff_folds_zero` | 2993 | 0 | 0 | OK |
| `pin_trapdoor_monomial_poly_inverts` | 3013 | 0 | 0 | OK |
| `pin_crt_vs_monomial_diff_folds_zero` | 3025 | 0 | 0 | OK |
