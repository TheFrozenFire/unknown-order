...
| `arith_witness_gap_no_split` | 63 | 0 | 0 | OK |
| `arith_takagi_shape` | 69 | 0 | 0 | OK |
| `arith_takagi_euler_p2` | 75 | 0 | 0 | OK |
| `arith_takagi_p_on_tape` | 79 | 0 | 0 | OK |
| `arith_double_y_not_root` | 85 | 0 | 0 | OK |
| `prime_37` | 91 | 0 | 0 | OK |
| `arith_nextprime_e37` | 106 | 0 | 0 | OK |
| `arith_nextprime_residual` | 112 | 0 | 0 | OK |
| `arith_nextprime_root_is_49` | 116 | 0 | 0 | OK |
| `arith_cf_euclidean` | 122 | 0 | 0 | OK |
| `arith_cf_convergents_not_root` | 126 | 0 | 0 | OK |
| `arith_two_moduli_coprime` | 132 | 0 | 0 | OK |
| `arith_two_moduli_same_x` | 136 | 0 | 0 | OK |
| `three_prime_357` | 143 | 0 | 0 | OK |
| `arith_mixed_pqr_is_factor` | 150 | 0 | 0 | OK |
| `arith_composite_e15_shares_lambda` | 162 | 0 | 0 | OK |
| `arith_36_not_in_ltwo` | 178 | 0 | 0 | OK |
| `arith_two_and_thirtysix_same_order_period` | 182 | 0 | 0 | OK |
...
| `filter_jacobi_branch_lambda_type` | 119 | 0 | 0 | OK |
| `filter_jacobi_branch_not_residual` | 123 | 0 | 0 | OK |
| `filter_cube_fails_public_e` | 131 | 0 | 0 | OK |
| `filter_e11_passes_public_e` | 135 | 0 | 0 | OK |
| `filter_public_e11_miller_splits` | 139 | 0 | 0 | OK |
| `filter_lowbit_e9` | 151 | 0 | 0 | OK |
| `filter_lowbit_e9_residual` | 155 | 0 | 0 | OK |
| `filter_lowbit_root_is_70` | 159 | 0 | 0 | OK |
| `filter_trace_not_root` | 165 | 0 | 0 | OK |
| `filter_torus_order_not_Nplus1` | 169 | 0 | 0 | OK |
| `filter_residual_tests_on_cube` | 180 | 0 | 0 | OK |
| `filter_e5_shares_lambda` | 190 | 0 | 0 | OK |
| `filter_e15_odd_shares_lambda` | 195 | 0 | 0 | OK |
| `filter_e7_residual_shaped` | 200 | 0 | 0 | OK |
| `filter_e5_passes_public_e` | 210 | 0 | 0 | OK |
| `filter_e7_passes_public_e` | 214 | 0 | 0 | OK |
| `filter_e_coprime_N_cube_passes` | 218 | 0 | 0 | OK |
| `filter_e_coprime_N_accepts_nonresidual` | 222 | 0 | 0 | OK |
| `filter_e_coprime_N_does_not_certify` | 227 | 0 | 0 | OK |
| `filter_phi_y_of_36` | 232 | 0 | 0 | OK |
| `filter_e_coprime_phi_y_rejects_cube` | 240 | 0 | 0 | OK |
| `filter_jacobi_x_plus` | 252 | 0 | 0 | OK |
| `filter_jacobi_10_plus_not_leftover` | 257 | 0 | 0 | OK |
| `filter_jacobi_2_minus` | 261 | 0 | 0 | OK |
| `filter_x_cube_check_is_rsa_e3` | 266 | 0 | 0 | OK |
...
| `poly_e_square_even_peel` | 154 | 0 | 0 | OK |
| `reject_sample_public_e_emits_5` | 165 | 0 | 0 | OK |
| `reject_sample_emits_nonresidual` | 169 | 0 | 0 | OK |
...
| `shape_inverse_of_36_residual_shaped` | 53 | 0 | 0 | OK |
| `shape_inverse_of_generator` | 57 | 0 | 0 | OK |
| `shape_inverse_generator_miller` | 62 | 0 | 0 | OK |
| `shape_affine_identity_forbidden` | 72 | 0 | 0 | OK |
| `shape_affine_eval_not_zero` | 81 | 0 | 0 | OK |
| `shape_affine_pointwise_const_residual` | 85 | 0 | 0 | OK |
| `shape_eth_root_of_1` | 91 | 0 | 0 | OK |
| `shape_unique_eth_root` | 107 | 0 | 0 | OK |
| `shape_two_unit_cube_roots_agree` | 120 | 0 | 0 | OK |
| `shape_unique_unit_cube_root_of_36` | 135 | 0 | 0 | OK |
| `shape_fr_small_integer` | 150 | 0 | 0 | OK |
| `shape_fr_cube_gap_small` | 154 | 0 | 0 | OK |
| `shape_fr_residual_not_integer_cube` | 159 | 0 | 0 | OK |
| `shape_fr_reduced_offset_not_integer` | 163 | 0 | 0 | OK |
| `shape_chaum_unblind` | 170 | 0 | 0 | OK |
| `shape_chaum_recovers_cube_root` | 180 | 0 | 0 | OK |
| `shape_chaum_e_is_protocol` | 184 | 0 | 0 | OK |
| `shape_jacobi_e_on_square` | 193 | 0 | 0 | OK |
| `shape_jacobi_e_on_nonsquare` | 198 | 0 | 0 | OK |
| `shape_short_period_of_y_no_split` | 206 | 0 | 0 | OK |
| `shape_lambda_quality_miller` | 210 | 0 | 0 | OK |
| `shape_ed_minus_one_is_lambda` | 220 | 0 | 0 | OK |
| `shape_ed_miller` | 225 | 0 | 0 | OK |
| `shape_e3_not_invertible_mod_Nminus1` | 235 | 0 | 0 | OK |
| `shape_wrong_euler_inv` | 240 | 0 | 0 | OK |
| `shape_crt_residues` | 246 | 0 | 0 | OK |
| `shape_crt_recovers_root` | 251 | 0 | 0 | OK |
| `shape_crt_moduli_are_factors` | 255 | 0 | 0 | OK |
| `shape_miller_e11_on_y_splits` | 261 | 0 | 0 | OK |
| `shape_miller_e3_on_y_survives` | 269 | 0 | 0 | OK |
| `shape_public_chain_e3` | 281 | 0 | 0 | OK |
| `shape_trapdoor_chain_d27` | 285 | 0 | 0 | OK |
| `shape_poly_x_quadratic` | 289 | 0 | 0 | OK |
| `shape_public_bases_2_3` | 293 | 0 | 0 | OK |
| `shape_gcdfree_bounded_from_y` | 297 | 0 | 0 | OK |
| `shape_public_exp_not_membership` | 301 | 0 | 0 | OK |
...
| `dict_y_to_d` | 37 | 0 | 0 | OK |
| `dict_x93_e67` | 41 | 0 | 0 | OK |
| `dict_x25_e11` | 45 | 0 | 0 | OK |
| `dict_x25_e51` | 49 | 0 | 0 | OK |
| `dict_x15_e29` | 53 | 0 | 0 | OK |
| `dict_x15_e69` | 57 | 0 | 0 | OK |
| `dict_x168_e61` | 61 | 0 | 0 | OK |
| `dict_x104_e57` | 65 | 0 | 0 | OK |
| `dict_x185_e53` | 69 | 0 | 0 | OK |
| `dict_xy_e41` | 73 | 0 | 0 | OK |
| `dict_y_lambda_type` | 77 | 0 | 0 | OK |
| `dict_e_plus_80` | 81 | 0 | 0 | OK |
| `dict_phi80` | 85 | 0 | 0 | OK |
| `dict_phi40` | 89 | 0 | 0 | OK |
| `dict_two_e_per_x` | 93 | 0 | 0 | OK |
| `dict_e_mod_40` | 97 | 0 | 0 | OK |
| `dict_kernel_1_41` | 101 | 0 | 0 | OK |
| `dict_cube_bij_on_cyc` | 107 | 0 | 0 | OK |
| `dict_27th_is_inverse_auto` | 111 | 0 | 0 | OK |
| `dict_compose_autos` | 115 | 0 | 0 | OK |
| `dict_ae_is_lambda_plus_1` | 120 | 0 | 0 | OK |
| `dict_bits_of_27` | 124 | 0 | 0 | OK |
| `dict_binary_product` | 128 | 0 | 0 | OK |
| `dict_add_chain_y6` | 132 | 0 | 0 | OK |
| `dict_add_chain_y12` | 136 | 0 | 0 | OK |
| `dict_add_chain_y24` | 140 | 0 | 0 | OK |
| `dict_k_odd` | 144 | 0 | 0 | OK |
| `dict_hamming_27` | 148 | 0 | 0 | OK |
| `dict_naf_shape` | 152 | 0 | 0 | OK |
| `dict_y25` | 156 | 0 | 0 | OK |
| `dict_y16_is_g5sq` | 160 | 0 | 0 | OK |
| `dict_sagm_on_y` | 164 | 0 | 0 | OK |
| `dict_y81` | 168 | 0 | 0 | OK |
| `dict_ae_lambda_plus_1` | 172 | 0 | 0 | OK |
| `dict_e43_same_x` | 176 | 0 | 0 | OK |
| `dict_e83_same_x` | 180 | 0 | 0 | OK |
| `dict_e43_minus_3` | 184 | 0 | 0 | OK |
| `dict_e83_minus_3` | 188 | 0 | 0 | OK |
| `dict_e67_coprime` | 192 | 0 | 0 | OK |
| `dict_e51_coprime` | 196 | 0 | 0 | OK |
| `dict_e61_coprime` | 200 | 0 | 0 | OK |
| `dict_e57_coprime` | 204 | 0 | 0 | OK |
| `dict_e29_coprime` | 208 | 0 | 0 | OK |
| `dict_e39_coprime` | 212 | 0 | 0 | OK |
| `dict_x26_e39` | 216 | 0 | 0 | OK |
| `dict_self_inverse_11` | 220 | 0 | 0 | OK |
| `dict_sagm_ae_minus_1` | 224 | 0 | 0 | OK |
| `dict_inv_mod_40` | 228 | 0 | 0 | OK |
| `dict_inv_mod_lam` | 232 | 0 | 0 | OK |
| `dict_cycle_70_cube` | 236 | 0 | 0 | OK |
| `dict_cycle_42_cube` | 240 | 0 | 0 | OK |
| `dict_cycle_36_cube` | 244 | 0 | 0 | OK |
| `dict_cycle_93_cube` | 248 | 0 | 0 | OK |
| `dict_three_order_4_mod_40` | 252 | 0 | 0 | OK |
| `dict_27_order_4_mod_40` | 256 | 0 | 0 | OK |
| `dict_cycle2_9` | 260 | 0 | 0 | OK |
| `dict_cycle2_168` | 264 | 0 | 0 | OK |
| `dict_cycle2_15` | 268 | 0 | 0 | OK |
| `dict_k27_coords` | 272 | 0 | 0 | OK |
| `dict_e3_coords` | 277 | 0 | 0 | OK |
| `dict_3_order_4_mod_40` | 282 | 0 | 0 | OK |
| `dict_cube_root_of_2` | 287 | 0 | 0 | OK |
| `dict_sagm_of_3` | 291 | 0 | 0 | OK |
| `dict_75_not_42` | 295 | 0 | 0 | OK |
| `dict_cycle2_60` | 299 | 0 | 0 | OK |
| `dict_cycle3_25` | 303 | 0 | 0 | OK |
| `dict_cycle3_104` | 307 | 0 | 0 | OK |
| `dict_cycle3_59` | 311 | 0 | 0 | OK |
| `dict_cycle3_53` | 315 | 0 | 0 | OK |
| `dict_cycle4_49` | 319 | 0 | 0 | OK |
| `dict_cycle4_26` | 323 | 0 | 0 | OK |
| `dict_cycle4_185` | 327 | 0 | 0 | OK |
| `dict_cycle4_179` | 331 | 0 | 0 | OK |
| `dict_cbrt_2_in_ltwo` | 335 | 0 | 0 | OK |
| `dict_cbrt_3_in_lthree` | 339 | 0 | 0 | OK |
| `dict_cbrt_36_in_ly` | 343 | 0 | 0 | OK |
| `dict_three_x_for_k27` | 348 | 0 | 0 | OK |
...
| `extra_same_y_two_moduli` | 109 | 0 | 0 | OK |
| `extra_twin_exponents` | 114 | 0 | 0 | OK |
| `extra_product_of_leftovers` | 118 | 0 | 0 | OK |
| `extra_rerand_forces_fixed_e` | 122 | 0 | 0 | OK |
| `extra_coins_independent_fixed_e` | 126 | 0 | 0 | OK |
| `extra_squaring_only` | 131 | 0 | 0 | OK |
| `extra_advice_on_y_lsb` | 135 | 0 | 0 | OK |
| `extra_streaming_first_bit` | 139 | 0 | 0 | OK |
| `extra_dl_base3` | 143 | 0 | 0 | OK |
| `extra_p_plus_q` | 147 | 0 | 0 | OK |
| `extra_torus_order_is_y` | 151 | 0 | 0 | OK |
| `extra_hamming_N` | 155 | 0 | 0 | OK |
| `extra_digit_reverse_splits` | 159 | 0 | 0 | OK |
| `extra_digits_of_N` | 167 | 0 | 0 | OK |
| `extra_N_mod_100` | 171 | 0 | 0 | OK |
| `extra_nextprime_N` | 175 | 0 | 0 | OK |
| `extra_prevprime_associate` | 179 | 0 | 0 | OK |
| `extra_xor_leftovers` | 183 | 0 | 0 | OK |
| `extra_related_y_cube` | 187 | 0 | 0 | OK |
| `extra_leftover_pair_splits` | 191 | 0 | 0 | OK |
| `extra_first_nibble` | 199 | 0 | 0 | OK |
| `extra_two_bit_advice` | 203 | 0 | 0 | OK |
| `extra_dl_base5` | 207 | 0 | 0 | OK |
| `extra_dl_base9` | 211 | 0 | 0 | OK |
| `extra_gen_pair_42_9` | 215 | 0 | 0 | OK |
| `extra_gen_pair_42_53` | 223 | 0 | 0 | OK |
| `extra_gen_pair_42_93` | 231 | 0 | 0 | OK |
| `extra_y_minus_x` | 239 | 0 | 0 | OK |
| `extra_advice_five_div_lam` | 243 | 0 | 0 | OK |
| `extra_advice_local_9` | 247 | 0 | 0 | OK |
| `extra_euclid_x_minus_y` | 251 | 0 | 0 | OK |
| `extra_low_bits_y` | 255 | 0 | 0 | OK |
| `extra_hensel_p2` | 259 | 0 | 0 | OK |
| `extra_dp` | 263 | 0 | 0 | OK |
| `extra_edp_minus_1` | 267 | 0 | 0 | OK |
| `extra_dq` | 271 | 0 | 0 | OK |
| `extra_edq_minus_1` | 275 | 0 | 0 | OK |
| `extra_shamir_3_7` | 279 | 0 | 0 | OK |
| `extra_rerand_fixed_e` | 283 | 0 | 0 | OK |
...
| `period_miller_on_period2` | 90 | 0 | 0 | OK |
| `period_local_orders` | 98 | 0 | 0 | OK |
| `period_gcd_pminus1_qminus1` | 105 | 0 | 0 | OK |
| `period_public_d5_pohlig` | 109 | 0 | 0 | OK |
| `period_mismatched_local_orders` | 117 | 0 | 0 | OK |
| `period_lcm_local_orders` | 122 | 0 | 0 | OK |
| `period_v2_local_orders` | 126 | 0 | 0 | OK |
| `period_gcd_path_splits` | 131 | 0 | 0 | OK |
| `period_exp_path_leftover` | 139 | 0 | 0 | OK |
| `period_eq_order_40` | 147 | 0 | 0 | OK |
| `period_eq_not_8` | 151 | 0 | 0 | OK |
| `period_eq_not_5` | 155 | 0 | 0 | OK |
| `period_eq_y40` | 159 | 0 | 0 | OK |
| `period_eq_y20` | 163 | 0 | 0 | OK |
| `period_eq_y8` | 167 | 0 | 0 | OK |
| `period_eq_y5` | 171 | 0 | 0 | OK |
| `period_gcd_y5_splits` | 175 | 0 | 0 | OK |
| `period_gcd_y8_splits` | 183 | 0 | 0 | OK |
| `period_gcd_full_period` | 191 | 0 | 0 | OK |
| `period_after_ord_invert` | 195 | 0 | 0 | OK |
| `period_v2_ord_p` | 203 | 0 | 0 | OK |
| `period_v2_ord_q` | 207 | 0 | 0 | OK |
| `period_v2_ord_N` | 211 | 0 | 0 | OK |
| `period_v2_lam_bigger` | 216 | 0 | 0 | OK |
| `period_x5_minus_1_splits` | 221 | 0 | 0 | OK |
| `period_x8_minus_1_splits` | 229 | 0 | 0 | OK |
| `period_x10_minus_1_splits` | 237 | 0 | 0 | OK |
| `period_x16_minus_1_splits` | 245 | 0 | 0 | OK |
| `period_x4_minus_1` | 253 | 0 | 0 | OK |
| `period_x2_minus_1` | 257 | 0 | 0 | OK |
| `period_same_oracle` | 261 | 0 | 0 | OK |
| `period_ten_order_16` | 265 | 0 | 0 | OK |
| `period_ten_pow8_miller` | 270 | 0 | 0 | OK |
| `period_ten_pow8_splits` | 274 | 0 | 0 | OK |
| `period_ten_pow16` | 282 | 0 | 0 | OK |
| `period_21_order_4` | 286 | 0 | 0 | OK |
| `period_21_sq_splits` | 290 | 0 | 0 | OK |
| `period_89_order_4` | 298 | 0 | 0 | OK |
| `period_77_pminus1` | 302 | 0 | 0 | OK |
| `period_77_qminus1` | 310 | 0 | 0 | OK |
| `period_77_leftover_pohlig` | 318 | 0 | 0 | OK |
| `period_77_ord2_is_lam` | 326 | 0 | 0 | OK |
| `period_two_subgroups_split` | 331 | 0 | 0 | OK |
| `period_three_pohlig_5` | 339 | 0 | 0 | OK |
| `period_three_pohlig_16` | 347 | 0 | 0 | OK |
| `period_three_pow8_no_split` | 355 | 0 | 0 | OK |
| `period_cbrt2_cbrt36_split` | 359 | 0 | 0 | OK |
| `period_cbrt3_cbrt36_split` | 367 | 0 | 0 | OK |
| `period_cbrt3_cbrt2` | 375 | 0 | 0 | OK |
| `period_five_max_order` | 379 | 0 | 0 | OK |
| `period_five_pohlig_5` | 383 | 0 | 0 | OK |
| `period_five_pohlig_16` | 391 | 0 | 0 | OK |
| `period_ord16_to_miller` | 399 | 0 | 0 | OK |
| `period_77_51_is_2_pow7` | 403 | 0 | 0 | OK |
| `period_77_lambda` | 407 | 0 | 0 | OK |
| `period_77_two_pow3` | 411 | 0 | 0 | OK |
| `period_77_two_pow5` | 419 | 0 | 0 | OK |
| `period_187_mismatch_gcd` | 431 | 0 | 0 | OK |
| `period_77_mismatch_gcd` | 435 | 0 | 0 | OK |
| `period_247_match_gcd` | 439 | 0 | 0 | OK |
| `period_247_leftover_pair` | 445 | 0 | 0 | OK |
| `period_247_residual_leaf` | 451 | 0 | 0 | OK |
| `period_247_local_residues` | 462 | 0 | 0 | OK |
| `period_247_matching_local_orders` | 467 | 0 | 0 | OK |
| `period_247_x5_minus_1_no_split` | 474 | 0 | 0 | OK |
| `period_247_x8_minus_1_no_split` | 478 | 0 | 0 | OK |
| `period_247_x6_minus_1_is_N` | 482 | 0 | 0 | OK |
| `period_Nminus1_factors` | 493 | 0 | 0 | OK |
| `period_pohlig_ndiv_Nminus1` | 497 | 0 | 0 | OK |
| `period_ord_ndiv_Nminus1` | 504 | 0 | 0 | OK |
| `period_Nminus1_divisors_no_split` | 510 | 0 | 0 | OK |
| `period_y_Nminus1_no_annihilator` | 514 | 0 | 0 | OK |
| `period_x_Nminus1_no_membership` | 518 | 0 | 0 | OK |
| `period_Nplus1_factors` | 522 | 0 | 0 | OK |
| `period_Nplus1_divisors_no_split` | 526 | 0 | 0 | OK |
| `period_y_Nplus1_no_annihilator` | 530 | 0 | 0 | OK |
| `period_lam_v2_odd_part` | 541 | 0 | 0 | OK |
| `period_M2_no_split` | 546 | 0 | 0 | OK |
| `period_M4_no_split` | 550 | 0 | 0 | OK |
| `period_advice_odd_part_splits` | 554 | 0 | 0 | OK |
| `period_advice_v2_8_splits` | 562 | 0 | 0 | OK |
| `period_advice_v2_16_splits` | 570 | 0 | 0 | OK |
| `period_advice_ord_invert_no_proper` | 578 | 0 | 0 | OK |
| `period_advice_lam_miller` | 582 | 0 | 0 | OK |
...
| `residual_phi_is_product` | 69 | 0 | 0 | OK |
| `residual_y_to_lam_identity` | 73 | 0 | 0 | OK |
| `residual_x_in_cyc_y` | 79 | 0 | 0 | OK |
| `residual_x_generates` | 83 | 0 | 0 | OK |
| `residual_x_is_y_to_27` | 87 | 0 | 0 | OK |
| `residual_cube_root_of_1` | 91 | 0 | 0 | OK |
| `residual_unique_unit_cube` | 95 | 0 | 0 | OK |
| `residual_e_inv_mod_16` | 99 | 0 | 0 | OK |
| `residual_e_inv_mod_5` | 103 | 0 | 0 | OK |
| `residual_crt_e_inverse` | 107 | 0 | 0 | OK |
| `residual_five_divides_lambda` | 113 | 0 | 0 | OK |
| `residual_local_squares` | 118 | 0 | 0 | OK |
| `residual_qr_both_sides` | 125 | 0 | 0 | OK |
| `residual_not_in_ltwo` | 130 | 0 | 0 | OK |
| `residual_in_lthree_and_lfive` | 134 | 0 | 0 | OK |
| `residual_local_cube_mod_p` | 138 | 0 | 0 | OK |
| `residual_local_x_mod_q` | 144 | 0 | 0 | OK |
| `residual_crt_locals` | 148 | 0 | 0 | OK |
| `residual_bits_of_x` | 153 | 0 | 0 | OK |
| `residual_x_mod_8` | 157 | 0 | 0 | OK |
| `residual_x_minus_1_prime` | 161 | 0 | 0 | OK |
| `residual_x_plus_1_prime` | 165 | 0 | 0 | OK |
| `residual_sixteen_generators` | 169 | 0 | 0 | OK |
| `residual_even_k_not_generator` | 173 | 0 | 0 | OK |
| `residual_y_inv_generator` | 181 | 0 | 0 | OK |
| `residual_x_inv_generator` | 185 | 0 | 0 | OK |
| `residual_y29` | 189 | 0 | 0 | OK |
| `residual_y3_generator` | 193 | 0 | 0 | OK |
| `residual_y9_generator` | 197 | 0 | 0 | OK |
| `residual_five_divides_ord` | 201 | 0 | 0 | OK |
| `residual_eight_divides_ord` | 205 | 0 | 0 | OK |
| `residual_three_index_two` | 209 | 0 | 0 | OK |
| `residual_dl_even` | 213 | 0 | 0 | OK |
| `residual_y_in_square_subgroup` | 217 | 0 | 0 | OK |
| `residual_v2_lambda` | 221 | 0 | 0 | OK |
| `residual_ord_divides_lam` | 226 | 0 | 0 | OK |
| `residual_y_to_ord` | 230 | 0 | 0 | OK |
| `residual_phi_over_lam` | 234 | 0 | 0 | OK |
| `residual_ord_div_lam` | 238 | 0 | 0 | OK |
| `residual_e_coprime_10_16` | 242 | 0 | 0 | OK |
| `residual_five_ndiv_e` | 247 | 0 | 0 | OK |
| `residual_y_local_qr` | 252 | 0 | 0 | OK |
| `residual_bitlength_lam` | 259 | 0 | 0 | OK |
| `residual_lambda_lcm` | 263 | 0 | 0 | OK |
| `residual_y_to_e_inv` | 267 | 0 | 0 | OK |
| `residual_k1_is_y` | 277 | 0 | 0 | OK |
| `residual_k3_is_y_cube` | 281 | 0 | 0 | OK |
| `residual_even_k_shares_ord` | 285 | 0 | 0 | OK |
| `residual_crt_is_residual_x` | 290 | 0 | 0 | OK |
| `residual_ratio_five_torsion` | 294 | 0 | 0 | OK |
| `residual_ratio_y4` | 298 | 0 | 0 | OK |
| `residual_ord_5_smooth` | 302 | 0 | 0 | OK |
| `residual_index_lam_over_ord` | 306 | 0 | 0 | OK |
| `residual_x_order_40_not_20` | 310 | 0 | 0 | OK |
| `residual_three_not_in_cyc_y` | 314 | 0 | 0 | OK |
| `residual_three_full_lambda` | 318 | 0 | 0 | OK |
| `residual_y_even_power_of_3` | 322 | 0 | 0 | OK |
| `residual_product_primaries` | 326 | 0 | 0 | OK |
| `residual_cube_of_x` | 330 | 0 | 0 | OK |
| `residual_y_to_27` | 334 | 0 | 0 | OK |
| `residual_jacobi_x_vs_2` | 338 | 0 | 0 | OK |
| `residual_x_not_in_lten` | 342 | 0 | 0 | OK |
| `residual_pminus1_qminus1` | 346 | 0 | 0 | OK |
| `residual_phi_product` | 351 | 0 | 0 | OK |
| `residual_index_four` | 355 | 0 | 0 | OK |
| `residual_x_order_40` | 359 | 0 | 0 | OK |
| `residual_v2_ord_x` | 363 | 0 | 0 | OK |
| `residual_v2_lam` | 368 | 0 | 0 | OK |
| `residual_x_generates_5_sylow` | 373 | 0 | 0 | OK |
| `residual_N_mod_8_for_2` | 377 | 0 | 0 | OK |
| `residual_ten_jacobi_plus` | 381 | 0 | 0 | OK |
| `residual_ten_not_ord40` | 385 | 0 | 0 | OK |
| `residual_21_mod_8` | 389 | 0 | 0 | OK |
| `residual_ltwo_ord40` | 393 | 0 | 0 | OK |
| `residual_two_ne_y` | 397 | 0 | 0 | OK |
| `residual_four_cosets` | 401 | 0 | 0 | OK |
| `residual_jacobi_plus_count` | 411 | 0 | 0 | OK |
| `residual_phi40_generators` | 416 | 0 | 0 | OK |
| `residual_coset_10_no_split` | 424 | 0 | 0 | OK |
| `residual_coset_2_no_split` | 428 | 0 | 0 | OK |
| `residual_x16_not_1` | 432 | 0 | 0 | OK |
| `residual_x8_not_1` | 436 | 0 | 0 | OK |
| `residual_lam_bitlength` | 440 | 0 | 0 | OK |
| `residual_x_local_qr` | 444 | 0 | 0 | OK |
| `residual_161_mod_8` | 449 | 0 | 0 | OK |
| `residual_x_not_ord16` | 454 | 0 | 0 | OK |
| `residual_x_not_ord10` | 458 | 0 | 0 | OK |
...
| `emap_lambda_y_even` | 39 | 0 | 0 | OK |
| `emap_bitlength_even` | 44 | 0 | 0 | OK |
| `emap_tau_leftover_e9` | 49 | 0 | 0 | OK |
| `emap_sigma_leftover` | 53 | 0 | 0 | OK |
| `emap_rad_even` | 57 | 0 | 0 | OK |
| `emap_omega_even` | 62 | 0 | 0 | OK |
| `emap_Omega_even` | 66 | 0 | 0 | OK |
| `emap_lpf_hits_cube` | 70 | 0 | 0 | OK |
| `emap_y_plus_1_is_nextprime` | 74 | 0 | 0 | OK |
| `emap_odd_part_e9` | 80 | 0 | 0 | OK |
| `emap_odd_hamming_shares` | 84 | 0 | 0 | OK |
| `emap_gcd_yminus1_Nminus1` | 89 | 0 | 0 | OK |
| `emap_phi3_y_leftover_shaped` | 93 | 0 | 0 | OK |
| `emap_v2_yminus1` | 103 | 0 | 0 | OK |
| `emap_mersenne_leftover` | 109 | 0 | 0 | OK |
| `emap_N_mod_y_hits_e7` | 113 | 0 | 0 | OK |
| `emap_fermatish_leftover` | 117 | 0 | 0 | OK |
| `emap_smooth_even` | 121 | 0 | 0 | OK |
| `emap_e_eq_N` | 126 | 0 | 0 | OK |
| `emap_e_eq_Nminus2` | 130 | 0 | 0 | OK |
| `emap_e_y_minus_1_shares` | 134 | 0 | 0 | OK |
| `emap_e_two_y_plus_1` | 138 | 0 | 0 | OK |
| `emap_e_two_y_minus_1` | 142 | 0 | 0 | OK |
| `emap_prevprime_e31` | 146 | 0 | 0 | OK |
| `emap_dedekind_psi_even` | 150 | 0 | 0 | OK |
| `emap_ord_y_even` | 155 | 0 | 0 | OK |
| `emap_phi_N_even` | 159 | 0 | 0 | OK |
| `emap_aliquot_shares` | 163 | 0 | 0 | OK |
| `emap_e17_leftover` | 168 | 0 | 0 | OK |
| `emap_e_N_plus_1_even` | 172 | 0 | 0 | OK |
| `emap_e_N_minus_1_even` | 176 | 0 | 0 | OK |
| `emap_e_lam_minus_1` | 180 | 0 | 0 | OK |
| `emap_phi_y_plus_1` | 184 | 0 | 0 | OK |
| `emap_digit_sum_e9` | 188 | 0 | 0 | OK |
| `emap_repunit_111` | 192 | 0 | 0 | OK |
| `emap_primorial_even` | 196 | 0 | 0 | OK |
| `emap_fermat_5_shares` | 201 | 0 | 0 | OK |
| `emap_collatz_e21` | 206 | 0 | 0 | OK |
| `emap_squarefree_core_e9` | 210 | 0 | 0 | OK |
| `emap_e47_second_leftover` | 214 | 0 | 0 | OK |
| `emap_e23_ninth` | 218 | 0 | 0 | OK |
| `emap_e19_leftover` | 222 | 0 | 0 | OK |
| `emap_e_eq_x` | 226 | 0 | 0 | OK |
| `emap_e_N_minus_lam` | 230 | 0 | 0 | OK |
| `emap_e_nextprime_N` | 234 | 0 | 0 | OK |
| `emap_prevprime_even_peel` | 239 | 0 | 0 | OK |
| `emap_e_prime` | 243 | 0 | 0 | OK |
| `emap_prime_e7` | 248 | 0 | 0 | OK |
...
| `xmap_midpoint` | 35 | 0 | 0 | OK |
| `xmap_encrypt_as_decrypt` | 44 | 0 | 0 | OK |
| `xmap_not_coppersmith_small` | 48 | 0 | 0 | OK |
| `xmap_odd_monomial_y5` | 53 | 0 | 0 | OK |
| `xmap_y_to_the_y` | 57 | 0 | 0 | OK |
| `xmap_y_to_the_N` | 61 | 0 | 0 | OK |
| `xmap_y_to_Nminus1` | 65 | 0 | 0 | OK |
| `xmap_y_to_Nplus1` | 69 | 0 | 0 | OK |
| `xmap_floor_sqrt_y` | 73 | 0 | 0 | OK |
| `xmap_half_y` | 78 | 0 | 0 | OK |
| `xmap_bitrev_36_is_9` | 82 | 0 | 0 | OK |
| `xmap_triangular` | 86 | 0 | 0 | OK |
| `xmap_nextprime_as_x` | 90 | 0 | 0 | OK |
| `xmap_fibonacci_y` | 94 | 0 | 0 | OK |
| `xmap_exp_base2` | 98 | 0 | 0 | OK |
| `xmap_exp_base3` | 102 | 0 | 0 | OK |
| `xmap_phi3_of_y` | 106 | 0 | 0 | OK |
| `xmap_inv_then_cube` | 110 | 0 | 0 | OK |
| `xmap_cube_then_inv` | 114 | 0 | 0 | OK |
| `xmap_hybrid_crt` | 118 | 0 | 0 | OK |
| `xmap_mismatched_crt_splits` | 122 | 0 | 0 | OK |
| `xmap_integer_jnt` | 130 | 0 | 0 | OK |
| `xmap_y2_plus_1` | 135 | 0 | 0 | OK |
| `xmap_x_eq_Nminus1` | 139 | 0 | 0 | OK |
| `xmap_floor_sqrt_N` | 143 | 0 | 0 | OK |
| `xmap_phi3_of_N` | 147 | 0 | 0 | OK |
| `xmap_y7_onesided` | 151 | 0 | 0 | OK |
| `xmap_y9_cubes_to_root` | 155 | 0 | 0 | OK |
| `xmap_y11_onesided` | 159 | 0 | 0 | OK |
| `xmap_floor_y_div_3` | 163 | 0 | 0 | OK |
| `xmap_floor_N_div_y` | 167 | 0 | 0 | OK |
| `xmap_three_y_onesided` | 171 | 0 | 0 | OK |
| `xmap_y_minus_1` | 175 | 0 | 0 | OK |
| `xmap_y_plus_1_as_x` | 179 | 0 | 0 | OK |
| `xmap_two_y_plus_1` | 183 | 0 | 0 | OK |
| `xmap_y2_minus_1` | 187 | 0 | 0 | OK |
| `xmap_gray_code` | 191 | 0 | 0 | OK |
| `xmap_nibble_swap_nonunit` | 195 | 0 | 0 | OK |
| `xmap_popcount_as_x` | 203 | 0 | 0 | OK |
| `xmap_catalan_C5` | 207 | 0 | 0 | OK |
| `xmap_lucas_L8` | 217 | 0 | 0 | OK |
| `xmap_floor_y_three_halves` | 221 | 0 | 0 | OK |
| `xmap_shift_left_2_onesided` | 225 | 0 | 0 | OK |
| `xmap_y_mod_16` | 229 | 0 | 0 | OK |
| `xmap_eightbit_palindrome` | 233 | 0 | 0 | OK |
| `xmap_partition_p10` | 237 | 0 | 0 | OK |
| `xmap_catalan_C6_nonunit` | 245 | 0 | 0 | OK |
| `xmap_y_inv_sq` | 253 | 0 | 0 | OK |
| `xmap_x_eq_phi` | 257 | 0 | 0 | OK |
| `xmap_x_bitlength_N` | 261 | 0 | 0 | OK |
| `xmap_nextprime_mod_N` | 265 | 0 | 0 | OK |
| `xmap_identity_not_root` | 269 | 0 | 0 | OK |
| `xmap_y35_onesided` | 273 | 0 | 0 | OK |
| `xmap_inv_lam_minus_1` | 281 | 0 | 0 | OK |
| `xmap_pkcs_pad` | 285 | 0 | 0 | OK |
| `xmap_sqrt_then_n_nplus1` | 289 | 0 | 0 | OK |
| `xmap_integer_sqrt_unit` | 301 | 0 | 0 | OK |
| `xmap_binary_encrypt` | 305 | 0 | 0 | OK |
| `xmap_mont_form` | 309 | 0 | 0 | OK |
