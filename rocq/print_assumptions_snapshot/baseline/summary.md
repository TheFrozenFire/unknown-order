...
| `unique_eth_root_mod_prime` | 482 | 0 | 0 | OK |
| `pin_Fq_units_of_N_length` | 506 | 0 | 0 | OK |
| `pairwise_distinct_mod_filter` | 510 | 0 | 0 | OK |
| `pin_Fq_units_of_N_distinct` | 528 | 0 | 0 | OK |
| `pin_Fq_units_of_N_coprime` | 535 | 0 | 0 | OK |
| `pin_inv3_q_lt_window` | 552 | 0 | 0 | OK |
| `nth_poly_sub` | 556 | 0 | 0 | OK |
| `poly_degree_sub_le` | 564 | 0 | 0 | OK |
| `mod_product_r` | 575 | 0 | 0 | OK |
| `mod_product_l` | 587 | 0 | 0 | OK |
| `short_root_local_mod_q` | 593 | 0 | 0 | OK |
| `short_root_diff_vanishes` | 633 | 0 | 0 | OK |
| `short_root_q_divides_diff` | 655 | 0 | 0 | OK |
| `poly_eval_all_div` | 673 | 0 | 0 | OK |
| `poly_eval_single_support` | 687 | 0 | 0 | OK |
| `pin_two_pow_dbe_neq_2` | 719 | 0 | 0 | OK |
| `gcd_q_not_p` | 723 | 0 | 0 | OK |
| `powm_div_cong` | 750 | 0 | 0 | OK |
| `finite_support_cases` | 764 | 0 | 0 | OK |
| `short_root_poly_some_coeff_splits` | 788 | 0 | 0 | OK |
| `pin_crt_root_poly_is_short` | 871 | 0 | 0 | OK |
| `pin_crt_root_poly_short_splits` | 875 | 0 | 0 | OK |
| `no_root_poly_deg_lt_dq` | 885 | 0 | 0 | OK |
| `pin_Xn_dp_does_not_invert_all_units` | 902 | 0 | 0 | OK |
| `nodiv_gra_short_dq_splits` | 913 | 0 | 0 | OK |
| `nodiv_identity_bound_lt_dq` | 933 | 0 | 0 | OK |
| `nodiv_square_bound_lt_dq` | 938 | 0 | 0 | OK |
| `trapdoor_monomial_inverts_all_units` | 952 | 0 | 0 | OK |
| `monomial_all_units_invert_is_trapdoor` | 980 | 0 | 0 | OK |
| `pin_d_monomial_is_trapdoor` | 1021 | 0 | 0 | OK |
| `pin_dp_monomial_not_trapdoor` | 1025 | 0 | 0 | OK |
| `pin_dq_monomial_not_trapdoor` | 1029 | 0 | 0 | OK |
| `pin_d_plus_lam_is_trapdoor` | 1033 | 0 | 0 | OK |
