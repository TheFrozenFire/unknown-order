...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `cong_1_mod_p_0_mod_q_gcd` | 60 | 0 | 0 | OK |
| `crt_binomial_eval` | 94 | 0 | 0 | OK |
| `crt_binomial_mod_p` | 107 | 0 | 0 | OK |
| `crt_binomial_mod_q` | 128 | 0 | 0 | OK |
| `local_eth_root` | 149 | 0 | 0 | OK |
| `crt_binomial_inverts_units` | 177 | 0 | 0 | OK |
| `pin_root_ca_mod` | 220 | 0 | 0 | OK |
| `pin_root_cb_mod` | 224 | 0 | 0 | OK |
| `pin_inv3_local` | 228 | 0 | 0 | OK |
| `pin_root_ca_splits` | 233 | 0 | 0 | OK |
| `pin_root_cb_splits` | 246 | 0 | 0 | OK |
| `pin_crt_binomial_inverts_units` | 259 | 0 | 0 | OK |
| `pin_crt_binomial_eval_unit` | 282 | 0 | 0 | OK |
| `pin_ed_minus_1_divides_lam` | 295 | 0 | 0 | OK |
| `pin_powm_ed` | 304 | 0 | 0 | OK |
| `pin_unique_unit_eth_root` | 320 | 0 | 0 | OK |
| `pin_crt_binomial_at_y` | 332 | 0 | 0 | OK |
| `pin_crt_binomial_residual` | 344 | 0 | 0 | OK |
| `pin_crt_binomial_degree` | 351 | 0 | 0 | OK |
| `pin_crt_binomial_outside_window` | 355 | 0 | 0 | OK |
| `pin_crt_binomial_coeff_da` | 360 | 0 | 0 | OK |
| `pin_crt_binomial_coeff_db` | 364 | 0 | 0 | OK |
| `pin_trapdoor_monomial_eval` | 372 | 0 | 0 | OK |
| `pin_trapdoor_ed_inv` | 380 | 0 | 0 | OK |
| `pin_powm_de` | 384 | 0 | 0 | OK |
| `pin_trapdoor_monomial_inverts_units` | 401 | 0 | 0 | OK |
| `pin_trapdoor_monomial_at_y` | 409 | 0 | 0 | OK |
| `pin_trapdoor_monomial_degree` | 413 | 0 | 0 | OK |
| `pin_trapdoor_monomial_leading` | 417 | 0 | 0 | OK |
| `pin_trapdoor_degree_is_d` | 427 | 0 | 0 | OK |
| `pin_trapdoor_monomial_outside_window` | 434 | 0 | 0 | OK |
| `pin_root_polys_agree_on_units` | 441 | 0 | 0 | OK |
| `root_poly_eval_coprime` | 461 | 0 | 0 | OK |
| `all_units_root_poly_is_trapdoor_map` | 475 | 0 | 0 | OK |
| `all_units_root_poly_eval_g` | 496 | 0 | 0 | OK |
| `pin_trapdoor_monomial_is_trapdoor_map` | 506 | 0 | 0 | OK |
| `pin_crt_binomial_neq_monomial` | 516 | 0 | 0 | OK |
| `pin_crt_binomial_inverts_2` | 526 | 0 | 0 | OK |
| `unique_eth_root_mod_prime` | 549 | 0 | 0 | OK |
| `pin_Fq_units_of_N_length` | 573 | 0 | 0 | OK |
| `pairwise_distinct_mod_filter` | 577 | 0 | 0 | OK |
| `pin_Fq_units_of_N_distinct` | 595 | 0 | 0 | OK |
| `pin_Fq_units_of_N_coprime` | 602 | 0 | 0 | OK |
| `pin_inv3_q_lt_window` | 619 | 0 | 0 | OK |
| `nth_poly_sub` | 623 | 0 | 0 | OK |
| `poly_degree_sub_le` | 631 | 0 | 0 | OK |
| `mod_product_r` | 642 | 0 | 0 | OK |
| `mod_product_l` | 654 | 0 | 0 | OK |
| `short_root_local_mod_q` | 660 | 0 | 0 | OK |
| `short_root_diff_vanishes` | 700 | 0 | 0 | OK |
| `short_root_q_divides_diff` | 722 | 0 | 0 | OK |
| `poly_eval_all_div` | 741 | 0 | 0 | OK |
| `poly_eval_single_support` | 755 | 0 | 0 | OK |
| `pin_two_pow_dbe_neq_2` | 787 | 0 | 0 | OK |
| `gcd_q_not_p` | 791 | 0 | 0 | OK |
| `powm_div_cong` | 818 | 0 | 0 | OK |
| `finite_support_cases` | 832 | 0 | 0 | OK |
| `short_root_poly_some_coeff_splits` | 856 | 0 | 0 | OK |
| `pin_crt_root_poly_is_short` | 940 | 0 | 0 | OK |
| `pin_crt_root_poly_short_splits` | 944 | 0 | 0 | OK |
| `no_root_poly_deg_lt_dq` | 956 | 0 | 0 | OK |
| `pin_Xn_dp_does_not_invert_all_units` | 973 | 0 | 0 | OK |
| `nodiv_gra_short_dq_splits` | 984 | 0 | 0 | OK |
| `nodiv_identity_bound_lt_dq` | 1006 | 0 | 0 | OK |
| `nodiv_square_bound_lt_dq` | 1011 | 0 | 0 | OK |
| `trapdoor_monomial_inverts_all_units` | 1027 | 0 | 0 | OK |
| `monomial_all_units_invert_is_trapdoor` | 1055 | 0 | 0 | OK |
| `pin_d_monomial_is_trapdoor` | 1096 | 0 | 0 | OK |
| `pin_dp_monomial_not_trapdoor` | 1100 | 0 | 0 | OK |
| `pin_dq_monomial_not_trapdoor` | 1104 | 0 | 0 | OK |
| `pin_d_plus_lam_is_trapdoor` | 1108 | 0 | 0 | OK |
| `pin_d_plus_2lam_is_trapdoor` | 1112 | 0 | 0 | OK |
| `pin_trapdoor_k_M_pos` | 1116 | 0 | 0 | OK |
| `monomial_all_units_invert_miller` | 1129 | 0 | 0 | OK |
| `pin_miller_from_d_plus_lam` | 1160 | 0 | 0 | OK |
| `pin_base2_height_p_at_35` | 1182 | 0 | 0 | OK |
| `pin_base2_height_q_at_35` | 1190 | 0 | 0 | OK |
| `pin_odd_part_d_plus_2lam` | 1200 | 0 | 0 | OK |
| `pin_miller_from_d_plus_2lam` | 1204 | 0 | 0 | OK |
| `pin_d_mod_pminus1` | 1228 | 0 | 0 | OK |
| `pin_d_mod_qminus1` | 1232 | 0 | 0 | OK |
| `pin_inv3_p_is_crt_dp` | 1236 | 0 | 0 | OK |
| `pin_inv3_q_is_crt_dq` | 1240 | 0 | 0 | OK |
| `pin_local_inverses_recover_d` | 1244 | 0 | 0 | OK |
| `pin_local_inv_unique_p` | 1262 | 0 | 0 | OK |
| `pin_local_inv_unique_q` | 1274 | 0 | 0 | OK |
| `pin_mid_root_poly_degree` | 1295 | 0 | 0 | OK |
| `pin_mid_root_poly_in_window` | 1299 | 0 | 0 | OK |
| `pin_mid_root_poly_inverts_units` | 1303 | 0 | 0 | OK |
| `pin_mid_root_poly_splits` | 1317 | 0 | 0 | OK |
| `pin_p_lt_q` | 1332 | 0 | 0 | OK |
| `pin_Fp_units_of_N_length` | 1337 | 0 | 0 | OK |
| `pin_Fp_units_of_N_distinct` | 1341 | 0 | 0 | OK |
| `pin_Fp_units_of_N_coprime` | 1345 | 0 | 0 | OK |
| `short_root_local_mod_p` | 1360 | 0 | 0 | OK |
| `invert_all_units_local_p` | 1400 | 0 | 0 | OK |
| `invert_all_units_local_q` | 1411 | 0 | 0 | OK |
| `powm_reduce_period` | 1430 | 0 | 0 | OK |
| `nth_map_seq_Z` | 1466 | 0 | 0 | OK |
| `nth_poly_fold` | 1480 | 0 | 0 | OK |
| `poly_fold_length` | 1491 | 0 | 0 | OK |
| `poly_degree_fold_lt` | 1497 | 0 | 0 | OK |
| `map_plus_is_poly_add` | 1512 | 0 | 0 | OK |
| `map_seq_succ` | 1522 | 0 | 0 | OK |
| `poly_eval_map_seq_S` | 1532 | 0 | 0 | OK |
| `poly_eval_zeros_seq` | 1543 | 0 | 0 | OK |
| `poly_eval_delta_seq` | 1552 | 0 | 0 | OK |
| `poly_eval_from_scale` | 1583 | 0 | 0 | OK |
| `poly_eval_from_0` | 1594 | 0 | 0 | OK |
| `poly_eval_fold_from` | 1600 | 0 | 0 | OK |
| `poly_eval_fold_mod` | 1651 | 0 | 0 | OK |
| `pin_inv3_p_lt_pminus1` | 1664 | 0 | 0 | OK |
| `invert_fold_p_diff_vanishes` | 1668 | 0 | 0 | OK |
| `invert_all_units_fold_p` | 1702 | 0 | 0 | OK |
| `invert_all_units_fold_p_is_local_monomial` | 1727 | 0 | 0 | OK |
| `gcd_add_mul` | 1762 | 0 | 0 | OK |
| `pin_fermat_extra_divides_N` | 1774 | 0 | 0 | OK |
| `pin_fermat_root_poly_inverts_units` | 1797 | 0 | 0 | OK |
