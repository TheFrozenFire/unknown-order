...
**Headline:** all 2569 named results are **Closed under the global context** — **0 load-bearing axioms** across the whole corpus.

Captured for 2569 results across 119 files.
...
| Theorem | Line | total | load-bearing | status |
|---|---:|---:|---:|---|
| `cong_1_mod_p_0_mod_q_gcd` | 69 | 0 | 0 | OK |
| `crt_binomial_eval` | 103 | 0 | 0 | OK |
| `crt_binomial_mod_p` | 116 | 0 | 0 | OK |
| `crt_binomial_mod_q` | 137 | 0 | 0 | OK |
| `local_eth_root` | 158 | 0 | 0 | OK |
| `crt_binomial_inverts_units` | 186 | 0 | 0 | OK |
| `pin_root_ca_mod` | 229 | 0 | 0 | OK |
| `pin_root_cb_mod` | 233 | 0 | 0 | OK |
| `pin_inv3_local` | 237 | 0 | 0 | OK |
| `pin_root_ca_splits` | 242 | 0 | 0 | OK |
| `pin_root_cb_splits` | 255 | 0 | 0 | OK |
| `pin_crt_binomial_inverts_units` | 268 | 0 | 0 | OK |
| `pin_crt_binomial_eval_unit` | 291 | 0 | 0 | OK |
| `pin_ed_minus_1_divides_lam` | 304 | 0 | 0 | OK |
| `pin_powm_ed` | 313 | 0 | 0 | OK |
| `pin_unique_unit_eth_root` | 329 | 0 | 0 | OK |
| `pin_crt_binomial_at_y` | 341 | 0 | 0 | OK |
| `pin_crt_binomial_residual` | 353 | 0 | 0 | OK |
| `pin_crt_binomial_degree` | 360 | 0 | 0 | OK |
| `pin_crt_binomial_outside_window` | 364 | 0 | 0 | OK |
| `pin_crt_binomial_coeff_da` | 369 | 0 | 0 | OK |
| `pin_crt_binomial_coeff_db` | 373 | 0 | 0 | OK |
| `pin_trapdoor_monomial_eval` | 381 | 0 | 0 | OK |
| `pin_trapdoor_ed_inv` | 389 | 0 | 0 | OK |
| `pin_powm_de` | 393 | 0 | 0 | OK |
| `pin_trapdoor_monomial_inverts_units` | 410 | 0 | 0 | OK |
| `pin_trapdoor_monomial_at_y` | 418 | 0 | 0 | OK |
| `pin_trapdoor_monomial_degree` | 422 | 0 | 0 | OK |
| `pin_trapdoor_monomial_leading` | 426 | 0 | 0 | OK |
| `pin_trapdoor_degree_is_d` | 436 | 0 | 0 | OK |
| `pin_trapdoor_monomial_outside_window` | 443 | 0 | 0 | OK |
| `pin_root_polys_agree_on_units` | 450 | 0 | 0 | OK |
| `root_poly_eval_coprime` | 470 | 0 | 0 | OK |
| `all_units_root_poly_is_trapdoor_map` | 484 | 0 | 0 | OK |
| `all_units_root_poly_eval_g` | 505 | 0 | 0 | OK |
| `pin_trapdoor_monomial_is_trapdoor_map` | 515 | 0 | 0 | OK |
| `pin_crt_binomial_neq_monomial` | 525 | 0 | 0 | OK |
| `pin_crt_binomial_inverts_2` | 535 | 0 | 0 | OK |
| `unique_eth_root_mod_prime` | 558 | 0 | 0 | OK |
| `pin_Fq_units_of_N_length` | 582 | 0 | 0 | OK |
| `pairwise_distinct_mod_filter` | 586 | 0 | 0 | OK |
| `pin_Fq_units_of_N_distinct` | 604 | 0 | 0 | OK |
| `pin_Fq_units_of_N_coprime` | 611 | 0 | 0 | OK |
| `pin_inv3_q_lt_window` | 628 | 0 | 0 | OK |
| `nth_poly_sub` | 632 | 0 | 0 | OK |
| `poly_degree_sub_le` | 640 | 0 | 0 | OK |
| `mod_product_r` | 651 | 0 | 0 | OK |
| `mod_product_l` | 663 | 0 | 0 | OK |
| `short_root_local_mod_q` | 669 | 0 | 0 | OK |
| `short_root_diff_vanishes` | 709 | 0 | 0 | OK |
| `short_root_q_divides_diff` | 731 | 0 | 0 | OK |
| `poly_eval_all_div` | 750 | 0 | 0 | OK |
| `poly_eval_single_support` | 764 | 0 | 0 | OK |
| `pin_two_pow_dbe_neq_2` | 796 | 0 | 0 | OK |
| `gcd_q_not_p` | 800 | 0 | 0 | OK |
| `powm_div_cong` | 827 | 0 | 0 | OK |
| `finite_support_cases` | 841 | 0 | 0 | OK |
| `short_root_poly_some_coeff_splits` | 865 | 0 | 0 | OK |
| `pin_crt_root_poly_is_short` | 949 | 0 | 0 | OK |
| `pin_crt_root_poly_short_splits` | 953 | 0 | 0 | OK |
| `no_root_poly_deg_lt_dq` | 965 | 0 | 0 | OK |
| `pin_Xn_dp_does_not_invert_all_units` | 982 | 0 | 0 | OK |
| `nodiv_gra_short_dq_splits` | 993 | 0 | 0 | OK |
| `nodiv_identity_bound_lt_dq` | 1015 | 0 | 0 | OK |
| `nodiv_square_bound_lt_dq` | 1020 | 0 | 0 | OK |
| `trapdoor_monomial_inverts_all_units` | 1036 | 0 | 0 | OK |
| `monomial_all_units_invert_is_trapdoor` | 1064 | 0 | 0 | OK |
| `pin_d_monomial_is_trapdoor` | 1105 | 0 | 0 | OK |
| `pin_dp_monomial_not_trapdoor` | 1109 | 0 | 0 | OK |
| `pin_dq_monomial_not_trapdoor` | 1113 | 0 | 0 | OK |
| `pin_d_plus_lam_is_trapdoor` | 1117 | 0 | 0 | OK |
| `pin_d_plus_2lam_is_trapdoor` | 1121 | 0 | 0 | OK |
| `pin_trapdoor_k_M_pos` | 1125 | 0 | 0 | OK |
| `monomial_all_units_invert_miller` | 1138 | 0 | 0 | OK |
| `pin_miller_from_d_plus_lam` | 1169 | 0 | 0 | OK |
| `pin_base2_height_p_at_35` | 1191 | 0 | 0 | OK |
| `pin_base2_height_q_at_35` | 1199 | 0 | 0 | OK |
| `pin_odd_part_d_plus_2lam` | 1209 | 0 | 0 | OK |
| `pin_miller_from_d_plus_2lam` | 1213 | 0 | 0 | OK |
| `pin_d_mod_pminus1` | 1237 | 0 | 0 | OK |
| `pin_d_mod_qminus1` | 1241 | 0 | 0 | OK |
| `pin_inv3_p_is_crt_dp` | 1245 | 0 | 0 | OK |
| `pin_inv3_q_is_crt_dq` | 1249 | 0 | 0 | OK |
| `pin_local_inverses_recover_d` | 1253 | 0 | 0 | OK |
| `pin_local_inv_unique_p` | 1271 | 0 | 0 | OK |
| `pin_local_inv_unique_q` | 1283 | 0 | 0 | OK |
| `pin_mid_root_poly_degree` | 1304 | 0 | 0 | OK |
| `pin_mid_root_poly_in_window` | 1308 | 0 | 0 | OK |
| `pin_mid_root_poly_inverts_units` | 1312 | 0 | 0 | OK |
| `pin_mid_root_poly_splits` | 1326 | 0 | 0 | OK |
| `pin_p_lt_q` | 1341 | 0 | 0 | OK |
| `pin_Fp_units_of_N_length` | 1346 | 0 | 0 | OK |
| `pin_Fp_units_of_N_distinct` | 1350 | 0 | 0 | OK |
| `pin_Fp_units_of_N_coprime` | 1354 | 0 | 0 | OK |
| `short_root_local_mod_p` | 1369 | 0 | 0 | OK |
| `invert_all_units_local_p` | 1409 | 0 | 0 | OK |
| `invert_all_units_local_q` | 1420 | 0 | 0 | OK |
| `powm_reduce_period` | 1439 | 0 | 0 | OK |
| `nth_map_seq_Z` | 1475 | 0 | 0 | OK |
| `nth_poly_fold` | 1489 | 0 | 0 | OK |
| `poly_fold_length` | 1500 | 0 | 0 | OK |
| `poly_degree_fold_lt` | 1506 | 0 | 0 | OK |
| `map_plus_is_poly_add` | 1521 | 0 | 0 | OK |
| `map_seq_succ` | 1531 | 0 | 0 | OK |
| `poly_eval_map_seq_S` | 1541 | 0 | 0 | OK |
| `poly_eval_zeros_seq` | 1552 | 0 | 0 | OK |
| `poly_eval_delta_seq` | 1561 | 0 | 0 | OK |
| `poly_eval_from_scale` | 1592 | 0 | 0 | OK |
| `poly_eval_from_0` | 1603 | 0 | 0 | OK |
| `poly_eval_fold_from` | 1609 | 0 | 0 | OK |
| `poly_eval_fold_mod` | 1660 | 0 | 0 | OK |
| `pin_inv3_p_lt_pminus1` | 1673 | 0 | 0 | OK |
| `invert_fold_p_diff_vanishes` | 1677 | 0 | 0 | OK |
| `invert_all_units_fold_p` | 1711 | 0 | 0 | OK |
| `invert_all_units_fold_p_is_local_monomial` | 1736 | 0 | 0 | OK |
| `gcd_add_mul` | 1771 | 0 | 0 | OK |
| `pin_fermat_extra_divides_N` | 1783 | 0 | 0 | OK |
| `pin_fermat_root_poly_inverts_units` | 1806 | 0 | 0 | OK |
| `pin_fermat_root_poly_degree` | 1823 | 0 | 0 | OK |
| `pin_fermat_root_poly_splits` | 1827 | 0 | 0 | OK |
| `pin_gcd_add_mul_N` | 1837 | 0 | 0 | OK |
| `pin_inv3_q_lt_qminus1` | 1847 | 0 | 0 | OK |
| `invert_fold_q_diff_vanishes` | 1851 | 0 | 0 | OK |
| `invert_all_units_fold_q_eval` | 1887 | 0 | 0 | OK |
| `poly_degree_below_if_high_zero` | 1920 | 0 | 0 | OK |
| `pin_inv3_q_neq_qminus2` | 1935 | 0 | 0 | OK |
| `invert_all_units_fold_q_top_zero` | 1939 | 0 | 0 | OK |
| `invert_all_units_fold_q_is_local_monomial` | 2013 | 0 | 0 | OK |
| `invert_all_units_monomial_degree_mod_lam` | 2048 | 0 | 0 | OK |
| `poly_eval_cong` | 2069 | 0 | 0 | OK |
| `poly_eval_app` | 2086 | 0 | 0 | OK |
| `map_mul_length` | 2100 | 0 | 0 | OK |
| `geo_kernel_length` | 2112 | 0 | 0 | OK |
| `geo_kernel_identity` | 2121 | 0 | 0 | OK |
| `geo_kernel_at_base` | 2143 | 0 | 0 | OK |
| `p_plus_q_coprime` | 2169 | 0 | 0 | OK |
| `p_plus_q_mod_q` | 2189 | 0 | 0 | OK |
| `pin_p_plus_q_coprime` | 2196 | 0 | 0 | OK |
| `pin_p_plus_q_mod_q` | 2204 | 0 | 0 | OK |
| `pin_geo_kernel_vanishes` | 2213 | 0 | 0 | OK |
| `pin_geo_kernel_at_p_nonzero` | 2254 | 0 | 0 | OK |
| `pin_geo_kernel_at_2_mod_p` | 2258 | 0 | 0 | OK |
| `pin_binomial_plus_kernel_misses_lift` | 2265 | 0 | 0 | OK |
| `pin_Fq_units_or_p` | 2279 | 0 | 0 | OK |
| `invert_fold_q_at_lift` | 2292 | 0 | 0 | OK |
| `invert_fold_q_at_p` | 2357 | 0 | 0 | OK |
| `invert_fold_q_diff_vanishes_all` | 2370 | 0 | 0 | OK |
| `invert_all_units_fold_q` | 2387 | 0 | 0 | OK |
| `invert_all_units_fold_q_classes` | 2412 | 0 | 0 | OK |
| `invert_all_units_both_folds_are_local_monomials` | 2448 | 0 | 0 | OK |
| `invert_all_units_fold_degrees_crt_d` | 2464 | 0 | 0 | OK |
| `p_plus_k_q_mod_q` | 2479 | 0 | 0 | OK |
| `p_plus_k_q_coprime` | 2487 | 0 | 0 | OK |
| `pin_p_plus_2q_coprime` | 2509 | 0 | 0 | OK |
| `pin_p_plus_2q_mod_q` | 2518 | 0 | 0 | OK |
| `pin_p_plus_pq_shares_p` | 2524 | 0 | 0 | OK |
| `invert_fold_q_at_2q` | 2528 | 0 | 0 | OK |
| `geo_kernel_nth` | 2548 | 0 | 0 | OK |
| `pin_geo_kernel_degree` | 2580 | 0 | 0 | OK |
| `pin_geo_kernel_leading` | 2584 | 0 | 0 | OK |
| `pin_geo_kernel_lower_div_p` | 2593 | 0 | 0 | OK |
| `pin_geo_kernel_plus_q_cong` | 2606 | 0 | 0 | OK |
| `pin_crt_binomial_both_folds` | 2624 | 0 | 0 | OK |
