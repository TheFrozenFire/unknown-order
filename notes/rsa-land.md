...
| RSA inverter constructs a factor | **Open** `rsa_inverter_constructs_factor_open_named`. Pin reduced-units inverter factors (`rsa_inverter_reduced_units_constructs_factor_pin`, uses `pin_lam`). Scope: [`srsa.md`](srsa.md). Next slices: [`srsa-lift.md`](srsa-lift.md) |
