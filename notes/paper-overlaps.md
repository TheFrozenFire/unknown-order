...
| 5 | Low-order “in every imaginary-quadratic class group” | Belabas–Kleinjung–Sanso–Wesolowski 2020/1310 | *named, not formalized* | Broken for Mersenne-related discriminants (cubic-field extension suggested). `Cl[2]` (#4) is a different, public, break. This row is a *family* of class groups, not 2-torsion. |
