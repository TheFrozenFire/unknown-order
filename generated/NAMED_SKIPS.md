...
| `pin_209_is_blum` | `Miller.v` | 234 |
| `pin_209_miller_walk_base2_liar` | `Miller.v` | 238 |
| `pin_209_miller_walk_base3` | `Miller.v` | 242 |
| `pin_209_miller_search` | `Miller.v` | 250 |
| `pin_77_miller_walk_base2_hits` | `Miller.v` | 261 |
| `rsa_test_miller_split` | `Miller.v` | 266 |
| `rsa_test_miller_t` | `Miller.v` | 269 |
| `rsa_test_miller_s` | `Miller.v` | 272 |
| `rsa_test_base2_splits` | `Miller.v` | 276 |
...
| `pin_binomial_plus_N_kernel_cong_mod_N` | `SrsaRootPoly.v` | 4296 |
| `pin_binomial_plus_N_kernel_deg_lt_qminus1` | `SrsaRootPoly.v` | 4308 |
| `pin_miller_from_d_factors` | `SrsaRootPoly.v` | 4312 |
| `invert_all_units_poly_constructs_factor` | `SrsaRootPoly.v` | 4330 |
| `nodiv_gra_invert_all_units_constructs_factor` | `SrsaRootPoly.v` | 4378 |
| `invert_all_units_rational_is_trapdoor_map` | `SrsaRootPoly.v` | 4412 |
| `invert_all_units_rational_constructs_factor` | `SrsaRootPoly.v` | 4470 |
| `invert_all_units_rational_over_one` | `SrsaRootPoly.v` | 4486 |
| `invert_all_units_rational_monomial_over_one` | `SrsaRootPoly.v` | 4508 |
| `invert_all_units_rational_Xd1_over_X` | `SrsaRootPoly.v` | 4517 |
| `unit_ginv_gra_invert_all_units_constructs_factor` | `SrsaRootPoly.v` | 4550 |
...
|---|---|---:|
| `rsa_inverter_reduced_units_constructs_factor_pin` | `SrsaHom.v` | 95 |
| `inverter_as_residual_returns_e` | `SrsaInverter.v` | 236 |
| `inverter_as_residual_returns_e` | `SrsaInverter.v` | 236 |
...
| `pin_lambda_strong_solver_output_is_unit` | `SrsaInverter.v` | 266 |
| `pin_lambda_plus_one_does_not_split` | `SrsaInverter.v` | 274 |
...
_39 refuses, 10 open targets, 0 used-as-hypothesis weaknesses, 372 does-not-discharge rows._
