...
| `pin_lam_even` | `SrsaVaryingE.v` | 64 |
| `residual_shaped_e_plus_k_lam` | `SrsaVaryingE.v` | 67 |
| `unit_powm_plus_k_lam` | `SrsaVaryingE.v` | 91 |
| `residual_leaf_plus_k_lam` | `SrsaVaryingE.v` | 109 |
| `pin_e_plus_lam_residual` | `SrsaVaryingE.v` | 131 |
| `mul_cancel_mod_unit` | `SrsaVaryingE.v` | 145 |
| `same_unit_x_two_exponents_annihilates` | `SrsaVaryingE.v` | 162 |
| `powm_one_gcd_is_N` | `SrsaVaryingE.v` | 184 |
| `pin_x_lam_powm_one` | `SrsaVaryingE.v` | 197 |
| `pin_x_lam_gcd_is_N` | `SrsaVaryingE.v` | 201 |
| `pin_e7_minus_pin_e_does_not_miller` | `SrsaVaryingE.v` | 211 |
| `pin_base2_height_p_at_odd_part_of_lam_multiple` | `SrsaVaryingE.v` | 224 |
| `pin_base2_height_q_at_odd_part_of_lam_multiple` | `SrsaVaryingE.v` | 243 |
| `pin_miller_from_lambda_multiple` | `SrsaVaryingE.v` | 261 |
| `pin_miller_from_lam_factors` | `SrsaVaryingE.v` | 295 |
| `pin_miller_from_2lam_factors` | `SrsaVaryingE.v` | 302 |
| `pin_ed_minus_1_is_lam` | `SrsaVaryingE.v` | 310 |
| `pin_inv7_mod_lam` | `SrsaVaryingE.v` | 320 |
| `pin_y_to_23` | `SrsaVaryingE.v` | 324 |
| `pin_e7_residual` | `SrsaVaryingE.v` | 328 |
| `pin_e7_x_neq_pin_x` | `SrsaVaryingE.v` | 339 |
| `pin_e7_not_cong_pin_e` | `SrsaVaryingE.v` | 343 |
| `residual_e_cong_pin_e_ge` | `SrsaVaryingE.v` | 360 |
| `residual_solver_reduced_e_cong_x_is_trapdoor` | `SrsaVaryingE.v` | 369 |
| `residual_solver_reduced_e_cong_nonminimal_constructs_factor` | `SrsaVaryingE.v` | 397 |
| `residual_solver_reduced_e_cong_constructs_factor` | `SrsaVaryingE.v` | 416 |
| `pin_e_plus_lam_solver_e_cong` | `SrsaVaryingE.v` | 438 |
| `pin_e_plus_lam_solver_nonminimal` | `SrsaVaryingE.v` | 444 |
| `pin_e_plus_lam_solver_millers` | `SrsaVaryingE.v` | 451 |
| `pin_ed_inv_divides_lam` | `SrsaVaryingE.v` | 471 |
| `pin_ed_inv_M_pos` | `SrsaVaryingE.v` | 481 |
| `pin_powm_mul_inv` | `SrsaVaryingE.v` | 502 |
| `unique_unit_eth_root_inv` | `SrsaVaryingE.v` | 528 |
| `trapdoor_inhabits_residual_leaf_at` | `SrsaVaryingE.v` | 544 |
| `residual_shaped_e_7` | `SrsaVaryingE.v` | 563 |
| `residual_solver_reduced_fixed_e_is_trapdoor` | `SrsaVaryingE.v` | 573 |
| `residual_solver_reduced_fixed_e_constructs_factor` | `SrsaVaryingE.v` | 599 |
| `pin_e7_solver_returns_e` | `SrsaVaryingE.v` | 638 |
| `pin_e7_solver_constructs_factor` | `SrsaVaryingE.v` | 642 |
| `pin_miller_from_e7_inv` | `SrsaVaryingE.v` | 653 |
| `residual_shaped_e_11` | `SrsaVaryingE.v` | 662 |
| `pin_inv11_mod_lam` | `SrsaVaryingE.v` | 672 |
| `pin_miller_from_e11_inv` | `SrsaVaryingE.v` | 676 |
| `residual_solver_reduced_pin_e_via_fixed_e` | `SrsaVaryingE.v` | 687 |
...
| `matching_247_gcd_not_proper` | `SrsaOrderArrows.v` | 184 |
| `matching_247_two_sided_gcd_is_N` | `SrsaOrderArrows.v` | 194 |
| `pin_lambda_strong_solver_outputs_never_proper_gcd` | `SrsaVaryingE.v` | 50 |

_43 refuses, 3 open targets, 0 used-as-hypothesis weaknesses, 178 does-not-discharge rows._
