...
check(gcd(70-36,N)==17,                 "01 gcd(70-36,N)=17 one-sided");
...
check(gcd(168-36,N)==11,                "20 gcd(168-36,N)=11 one-sided");
...
check(gcd(85,N)==17,                    "23 gcd(85,N)=17 non-unit");
check(lift(Mod(85,N)^3)==17,            "23 85^3 ≡ 17 not 36");
check(lift(Mod(2,N)^36)==152,           "24 2^y ≡ 152");
check(lift(Mod(152,N)^3)==135,          "24 152^3 ≡ 135");
check(gcd(135-36,N)==11,                "24 gcd(135-36,N)=11 one-sided");
check(lift(Mod(3,N)^36)==47,            "25 3^y ≡ 47");
check((36^2+36+1)%N==24,                "26 Phi_3(y) ≡ 24");
check(lift(Mod(26,N)^3)==185,           "27 (y^{-1})^3 ≡ 185");
check(lift(Mod(185,N)^3)==179,          "27 185^3 ≡ 179");
check(gcd(179-36,N)==11,                "27 gcd(179-36,N)=11 one-sided");
check(lift(1/Mod(93,N))==185,           "28 (y^3)^{-1} ≡ 185");
check(gcd(179-36,N)==11,                "28 same residue one-sided split");
